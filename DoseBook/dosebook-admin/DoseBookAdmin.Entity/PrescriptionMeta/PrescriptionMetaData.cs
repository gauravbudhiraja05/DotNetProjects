...
namespace DoseBookAdmin.Entity.PrescriptionMeta
{
    ...
    public class PrescriptionMetaDataEntityList : List<PrescriptionMetaDataEntity>
    {

    }

    public class PrescriptionMetaDataListGridItemEntity
    {
        public PrescriptionMetaDataEntityList PrescriptionMetaDataEntityList { get; set; }

        public PrescriptionMetaTypeEntity PrescriptionMetaTypeEntity { get; set; }
    }
}
