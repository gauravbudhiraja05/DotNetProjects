...
<caption>Data Purge</caption>
    ...
    <tr>
        ...
        <asp:label  ID="lblDept" Text="Department" runat="server" CssClass="label"></asp:label>
        </td>
       ...
       <%-- <label id="lblclient" for="ctl00_mainplaceholder_ddlclient"  class="label" title="select client">client</label>--%>
        <asp:label ID="lblClient" Text="Client" runat="server" CssClass="label"  Width="100px"></asp:label>
        </td>
        ...
        <%-- <label id="lblLob" for="ctl00_MainPlaceHolder_ddlLob"  title="Select LOB" class="label">LOB</label>--%>
         ...
         <td dir="ltr" scope="row" title="Select LOB" CssClass="label">
...
<table cellpadding="0"  cellspacing="0"  width="90%" style="margin-left:30px; margin-right:30px"  summary="Contain Process Button">
    ...
    <tr>
        <td  align="left">
         ...
         <input type="button" id="btnProcess_singleuser"  value="Process" runat="server"   title="Click to Apply Condition" onclick="javascript:rowcount1();" class="button"/></td>
