...
Partial Class Graphs_graph
    ...
    Protected Sub get_tbcolumn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles get_tbcolumn.Click
        con.Close()
        con.Open()
        Dim com1 As New SqlCommand("select Visiblecolumn from WARSLOBTableMaster where Departmentid='" + DepartmentName.SelectedValue + "' and Clientid='" + ClientName.SelectedValue + "' and LOBid='" + ddlLobName.SelectedValue + "' and TableName='" + ddlTable.SelectedItem.Text + "'", con)
    ...
    Public Sub gridreportbind()
        ...
        Else
            com = New SqlCommand("select colname, wheredata,groupby, orderby,havingcondition from idmsreportmaster where queryname='" + ddlTable.SelectedItem.Text + "' and  departmentid='" + DepartmentName.SelectedValue + "' and  clientid='" + ClientName.SelectedValue + "' and  underlob='" + ddlLobName.SelectedValue + "'", con)
    ...
    Protected Sub plot_graph_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles plot_graph.Click
        ...
        plot_graph.Visible = False
    End Sub
    Protected Sub select_chart_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles select_chart.SelectedIndexChanged
    End Sub
