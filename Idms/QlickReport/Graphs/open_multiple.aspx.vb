...
Partial Class Graphs_open_multiple
    ...
    Protected Sub ddlLobName_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlLobName.SelectedIndexChanged
        ...
        selectedcols.Items.Clear()
        con.Open()
        cmd = New SqlCommand("Select Distinct(QueryName) from IdmsGraphMaster where DepartmentID='" + DepartmentName.SelectedValue + "' and ClientID='" + ClientName.SelectedValue + "' and UnderLOB='" + ddlLobName.SelectedValue + "' and  SavedBy='" + Session("userid") + "' ", con)
        dr = cmd.ExecuteReader()
    ...
    Protected Sub ddlgraph_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlgraph.SelectedIndexChanged
        ...
        con.Open()
        cmd = New SqlCommand("Select * from IdmsGraphMaster where DepartmentID='" + DepartmentName.SelectedValue + "' and ClientID='" + ClientName.SelectedValue + "' and UnderLOB='" + ddlLobName.SelectedValue + "' and SavedBy='" + Session("userid") + "' and QueryName='" + queryname.SelectedItem.Text + "' and GraphName='" + ddlgraph.SelectedItem.Text + "' ", con)
        dr = cmd.ExecuteReader()
        While (dr.Read())
    ...
    Protected Sub update_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles update.Click
        ...
        For k = 0 To a2 - 1
            ...
            End If
        Next
        cmd = New SqlCommand("Update IdmsGraphMaster set GraphType='" + gtype + "',DepartmentID='" + DepartmentName.SelectedValue + "',ClientID='" + ClientName.SelectedValue + "',UnderLOB='" + ddlLobName.SelectedValue + "',QueryName='" + queryname.SelectedItem.Text + "',ColumnName='" + sltcol + "',SavedBy='" + Session("userid") + "',Totalcolumn='" + repcol + "'where GraphName='" + ddlgraph.SelectedItem.Text + "'", con)
        con.Open()
        dr = cmd.ExecuteReader()
