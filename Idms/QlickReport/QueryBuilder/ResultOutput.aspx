...
<label   for="htmlqueryname"></label>
			...
			<table style="BACKGROUND-COLOR: white" cellspacing="0" cellpadding="0" border="0" summary="">
				<tr>
					...
					<td scope="col" style="WIDTH: 35px"><asp:imagebutton id="imgexl" alt="IMGEXL" BorderWidth="0" height="25" width="25" Runat="server" ImageUrl="/QlickReport/Images/excel_32.gif"></asp:imagebutton></td>
								...
								<tr>
								    <td>
								        <table>
								            ...
								            <tr>
									            <td scope="col"><label for="ddlClient" class="label">Client</label></td>
									            <td scope="col"><select id="ddlClient" onchange="javascript:GetLOB();" name="cboclient" runat="server" style="width: 114px"></select>
									            </td>
								            </tr>
								            <tr>
									            <td scope="col"><label for="ddlLob" class="label">LOB</label></td>
