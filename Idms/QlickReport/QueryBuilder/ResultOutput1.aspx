    ...
    <input type="hidden" name="__EVENTTARGET"/> <input type="hidden" name="__EVENTARGUMENT"/>
			...
			<table style="BACKGROUND-COLOR: white" cellspacing="0" cellpadding="0" border="0" summary="">
				<tr>
					...
					<td style="WIDTH: 35px"><asp:imagebutton id="imgexl" BorderWidth="0" height="25" AlternateText ="export to excel" width="25" Runat="server" ImageUrl="/QlickReport/Images/excel_32.gif"></asp:imagebutton></td>
