	            ...
	            <table cellspacing="0" cellpadding="0" width="90%" class="table" summary="purpose of this page is registration of new employee">
		                <caption class="caption" style="background:#666666">Login Information</caption>
        	                ...
        	                <tr>
			                    ...
			                    <asp:textbox id="txtUserId" tabindex="12"  BorderColor="black" BorderWidth="1" type="text" maxlength="15" tooltip="Enter User Id" runat="server" cssclass="textBox"></asp:textbox>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnAvailable" TabIndex="13" width="125" ToolTip="To Check User Id Availability" text ="Check Availability" runat="server" CssClass="button" />
