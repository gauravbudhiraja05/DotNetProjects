...
<asp:Content ID="LobMaster" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
...
function getclientid()
		...
		<asp:textbox id="txtSort" style="Z-INDEX: 100; LEFT: 952px; POSITION: absolute; TOP: 45px" runat="server"
			...
			<table cellspacing="0" cellpadding="0" width="90%"  class="table" summary="purpose of this page is creating  a LOB">
				<caption style ="background-color:#67A897">Add Level 3</caption>
				<tr>
					<td height="12" scope="col" ></td>
				</tr>
				<tr>
					<td><strong><asp:Label ID="lbl1" Text="Level 1" runat="server" ></asp:Label> </strong></td>
					<td scope ="col"  >
				...
				<tr>
					<td><strong><asp:Label ID="lbl2" Text="Level 2" runat="server" ></asp:Label> </strong></td>
					<td scope ="col"  >
				...
				<tr>
					<td><strong><asp:Label ID="lbl3" Text="Level 3" runat="server"></asp:Label></strong></td>
				...
				<tr>
					<td valign="top" align="center" colspan="2" scope ="colgroup">
						<div id="div2" style="color :Black ;overflow:scroll;width:100%;" runat="server">
							<asp:datagrid id="grdlob" runat="server" AutoGenerateColumns="False" AllowSorting="True" Width="100%"
								...
								<Columns>
                                    ...
                                    <asp:TemplateColumn SortExpression="departmentname" HeaderText="Level1 Name">
										<HeaderStyle CssClass="datagridHeader" Wrap="false" Font-Size="Small" Font-Bold="true" ></HeaderStyle>
										<ItemTemplate>
                                    ...
                                    <asp:TemplateColumn SortExpression="clientname" HeaderText="Level2 Name">
										<HeaderStyle CssClass="datagridHeader" Wrap="false" Font-Size="Small" Font-Bold="true"  ></HeaderStyle>
										<ItemTemplate>
									...
									<asp:TemplateColumn SortExpression="LOBName" HeaderText="Level3">
										<HeaderStyle CssClass="datagridHeader" Wrap="false" Font-Size="Small" Font-Bold="true"  ></HeaderStyle>
										<ItemTemplate>
									...
									<asp:TemplateColumn>
										...
										<HeaderTemplate >
											<center>
												<asp:LinkButton id="lkbtnSelectAll" Runat="server" Font-Size="XX-Small"  ToolTip="Select All CheckBox" CommandName="Select All" ><strong>Select All/</strong></asp:LinkButton>
												<asp:LinkButton id="lkbtnDeSelectAll" Runat="server" Font-Size="XX-Small"  ToolTip="DeSelect All CheckBox" CommandName="DeSelect All" ><strong>DeSelect All</strong></asp:LinkButton>
											</center>
										</HeaderTemplate>
										<ItemTemplate>
											<center>
