...
Partial Class analysisreport1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If rdr.Read Then
            ...
            If (producttype = "Multiple User") Then
                ...
                Me.ShowReport_multiuser.Visible = True
            Else
                Me.spandisplay.Visible = False
                Me.ShowReport_singleuser.Visible = True
            End If
            connection.Close()
        End If
    ...
    Protected Sub ShowReport_multiuser_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ShowReport_multiuser.Click
        ...
        Dim newarr As String = hidvalue().ToString
        Dim arrrs = newarr.Split(",")
        gridbind(level1.SelectedValue.ToString, level2.SelectedValue.ToString, level3.SelectedValue.ToString)
        'hid1.Value = ""
        'hid2.Value = ""
        'hid.Value = ""
    End Sub
