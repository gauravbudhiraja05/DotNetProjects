...
<label for="ctl00_MainPlaceHolder_cbolob2"></label>
				...
				<tr>
					<td colspan="1" style ="color:black" >
                        <asp:Label ID="Label2" runat="server" CssClass="label" Text="Name" ToolTip="Enter Name" Visible="False"></asp:Label>
						 </td>
						 <td colspan="3">
						<label for="ctl00_MainPlaceHolder_txtname"></label>
						 <asp:textbox id="txtname" tabindex="83" Runat="server" MaxLength="50" CssClass="text" ToolTip="Enter Name" Width="145px" Visible="False"></asp:textbox>&nbsp;
