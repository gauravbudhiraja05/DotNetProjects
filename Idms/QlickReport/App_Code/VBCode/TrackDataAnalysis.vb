...
Public Class TrackDataAnalysis
    ...
    Public Function BindUserAdminWise(ByVal AdminID As String)
        ...
        tempCmd1.Dispose()
    End Function
    Public Function BindDataAnalysisReport()
        ds.Clear()
        Dim str As String
        str = "Select Distinct(OnReport)  from LogDataAnalysis"
        ...
        da.Dispose()
    End Function
    Public Function AllAnalysisReportNameForUser(ByVal UserId As String)
        ds.Clear()
        Dim str As String
        str = "Select Distinct(OnReport) from LogDataAnalysis where UserID= '" + UserId + "'"
        da = New SqlDataAdapter(str, con)
        da.Fill(ds)
        con.Close()
        Return ds
    ...
    Public Function GetAllFormula()
        ds.Clear()
        Dim str As String
        str = "Select * from LogAnalysisFormula"
        da = New SqlDataAdapter(str, con)
        da.Fill(ds)
        con.Close()
        Return ds
    ...
    Public Function AllReportNameForAdmin(ByVal UserId As String)
        ...
        tempCmd2 = New SqlCommand("sp_GetReportForAnalysisByAdmin", con)
        tempCmd2.CommandType = CommandType.StoredProcedure
        tempCmd2.Parameters.Add("@AdminID", SqlDbType.VarChar, 200)
        tempCmd2.Parameters("@AdminID").Value = UserId
        con.Open()
