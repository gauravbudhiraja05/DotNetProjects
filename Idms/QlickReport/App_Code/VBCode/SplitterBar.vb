...
Namespace VwdCms
	...
	Public Class SplitterBar
		...
		Private _leftResizeTargets As String = String.Empty ' semi-colon delimited
		Private _rightResizeTargets As String = String.Empty ' semi-colon delimited
		Private _topResizeTargets As String = String.Empty ' semi-colon delimited
		Private _bottomResizeTargets As String = String.Empty ' semi-colon delimited
		...
		Private _totalWidth As Integer = 0 ' pixels, Total size of Left + Right target widths
		Private _saveWidthToElement As String = Nothing ' element id to save the width to (input text or hidden)
		'private int _maxHeight = 0; // pixels, max size of TopResizeTarget
		'private int _minHeight = 0; // pixels, min size of TopResizeTarget
		Private _totalHeight As Integer = 0 ' pixels, Total size of Top + Bottom target widths
		Private _saveHeightToElement As String = Nothing ' element id to save the Height to (input text or hidden)
		Private _onResizeStart As String = Nothing ' onmousedown fires this
		Private _onResize As String = Nothing ' dynamic resizing and onmouseup fires this
		Private _onResizeComplete As String = Nothing ' onmouseup fires this
		...
		Private Sub SetControlWidth(ByVal control As Control, ByVal width As String)
			If control IsNot Nothing Then
				...
				ElseIf TypeOf control Is HtmlControl Then
					Dim hc As HtmlControl = CType(control, HtmlControl)
		...
		Private Sub RegisterPageStartupScript()
			...
			Const newline As String = Constants.vbCrLf
