...
Partial Class Function_And_Process_IdmsClient
    ...
    Private Function ValidateLOB(ByVal lob)
        If objclass.checkAlphabetic(lob) = False Then
            WARSShowMsg("Client Name Must Be Alphabetic.")
    ...
    Private Function CheckExist(ByVal lob As String)
        ...
        If rdr.Read Then
            WARSShowMsg("This Client Name Already Exists")
            rdr.Close()
            connection.Close()
            com.Dispose()
            Return False
    ...
    Private Sub cmdSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        Try
            ...
            If department.SelectedIndex = 0 Then
                WARSShowMsg("Please Select Department Name!")
            End If
            If txtclient.Value = "" Then
                WARSShowMsg("Fill Client Name!")
                Exit Sub
            End If
            ...
            If com.ExecuteNonQuery() <> -1 Then
                WARSShowMsg("Client Added Successfully.")
                txtclient.Value = ""
                txtmsg.Value = ""
            End If
            com.Dispose()
    ...
    Private Sub grdlob_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles grdlob.ItemCommand
        ...
        If e.CommandName = "EditSave" Then
            ...
            If lob = "" Then
                ...
                WARSShowMsg(" Client Name can not be Blank")
                grdlob.EditItemIndex = e.Item.ItemIndex
    ...
    Private Sub UpdateLobName(ByVal name, ByVal msg, ByVal autoid)
        ...
        connection.Open()
        If com.ExecuteNonQuery() <> -1 Then
            WARSShowMsg("Client Updated Successfully.")
        End If
        connection.Close()
        com.Dispose()
    End Sub
    ...
    Private Sub dlbind(ByVal control As WebControls.DataGrid)
        Dim objcmd
        objcmd = New SqlCommand("select ic.AutoId,ic.ClientName,ic.message,SaveDate=convert(varchar,ic.SaveDate,106),ic.SavedBy,id.departmentname from idmsclient ic,idmsdepartment id where ic.deptid = id.autoid order by id.departmentname", connection)
