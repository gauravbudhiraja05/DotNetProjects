...
<asp:Content ID="leftPane" runat="server" ContentPlaceHolderID="LeftPlaceHolder">
     ...
     <script language="Javascript" src="../js/collapseableDIV.js" type="text/javascript"></script>  <%--This java script file show the div in left content page--%>
	    ...
	    function getValues()//This Function used in Save Graph
	    {
	        ...
	        else 
	        {
	         chk_re="on";
	   	    ...
	   	    document.getElementById("abc").value="X3DAngle:" + document.getElementById("<%=ddlXangle.ClientID%>").value  + "$" + "Perspective:" + document.getElementById("<%=ddlPerspective.ClientID%>").value + "$" + "Chk3D:"+ chk + "$" + "Y3Dangle:"+ document.getElementById("<%=ddlYang.ClientID%>").value + "$" + "Palettes:" + document.getElementById("<%=ddlPalettes.ClientID%>").value + "$" + "Bkclr:" + document.getElementById("<%=bkcolor.ClientID%>").value + "$" + "Gradient:" + document.getElementById("<%=ddlGradient.ClientID%>").value + "$" + "Hatchstyle:" + document.getElementById("<%=ddlHatchstyle.ClientID%>").value + "$" +  "Brclr:" + document.getElementById("<%=titlebordercolor.ClientID%>").value + "$" +  "Bordersize:" + document.getElementById("<%=ddlBordersize.ClientID%>").value + "$" + "Borderstyle:" + document.getElementById("<%=ddlBorderstyle.ClientID%>").value + "$" + "Xlabelfont:" + document.getElementById("<%=ddlXlabelfont.ClientID%>").value+ "$" + "Xfontsizelist:" + document.getElementById("<%=ddlXfontsizelist.ClientID%>").value + "$" + "XLabelcolour:" +  document.getElementById("<%=xaxiscolor.ClientID%>").value + "$" + "Xontanglelist:" + document.getElementById("<%=ddlXontanglelist.ClientID%>").value + "$" + "Offset:" + document.getElementById("<%=chkXoffset.ClientID%>").value;
	     	...
	     	if(("<%=currsp%>")=="")
	     	  {
	     	      ...
	     	      currentlobsapn=document.getElementById("<%=hiddlob.ClientID%>").value;
...
<div id="divScroll"  style="height:700px; width:220px; overflow:scroll; scrollbar-arrow-color:#0582BE; scrollbar-base-color:#58C7FC;">
   <div id="divScroll1" onclick="toggleDiv('divChart', 'imgChart',500)" style="cursor: pointer;background-color: #0582BE; color: White;">
        <table>
            <tr>
                <td style="width: 190px">
                    <label for="" title="Select Chart" class="leftLabel"><b>Select Chart</b></label> 
                </td>
                <td align="right">
   ...
   <div id="divChart" style="overflow: hidden; display: none;">
    ...
    <div id="div3" onclick="toggleDiv('divShow3dchart', 'imgFormat1',110)"
        style="cursor: pointer; background-color: #0591D3; color: White;">
        <table>
            <tr>
                <td style="width: 190px">
                    <label for="" title="Chart In 3D" class="leftLabel"><b>Chart In 3D</b></label> 
                </td>
                <td align="right">
    ...
    <div id="div6" onclick="toggleDiv('divChartappearance', 'img6',200)"
        ...
        <table>
            <tr>
                <td style="width: 190px">
                    <label for="" title="BackGround Apperance" class="leftLabel"><b>BackGround Apperance</b></label> 
                </td>
                <td align="right">
    ...
    <div id="divLegend" onclick="toggleDiv('divLegendappearance', 'img6',400)"
        style="cursor: pointer; background-color: #05A8F5; color: White;">
        <table>
            <tr>
                <td style="width: 190px">
                  <label for="" title="Legend Apperance" class="leftLabel"><b>Legend Apperance</b></label>
                </td>
                <td align="right">
    ...
    <div id="divLegendappearance" style="overflow: hidden; display: none; color: White;" title="This Table Holds Legend Background Appearence like Background Palettes, Background Style Etc.">
        <table summary="This Table Holds Legend Background Appearence like Background Palettes, Background Style Etc." style="width: 82%">
            <tr>
               ...
               <%--  <label class="leftLabel" title="Legend BackColor" for="ddlMinorWidth"></label>--%>BackColor</a>
                </td>
			...
			<tr>
				...
				<label class="leftLabel" for="chk_ShowMin">Show Total</label>
    ...
    <div id="div9" title="Label Format" onclick="toggleDiv('divLabelformat', 'img7',350)"
        style="cursor: pointer; background-color: #26B6FB; color: White;">
        ...
        <table summary="This Table Holds The X Axis Labels Font Name,Font Size,Text,Font Color,Offset.">
            <tr>
                <td colspan="2" scope="colgroup" title="Chart X-Axis Label Format" style="text-decoration: underline">
                        <label class="leftLabel" title=" X-Axis Chart Format" for="ddlMinorWidth"> X-Axis Chart Format</label>
                     </td>
            </tr>
            <tr>
        ...
        <table>
            <tr>
                <td colspan="2" scope="colgroup" title="Y-Axis Label Font Name" style="text-decoration: underline">
                    <label class="leftLabel" title=" Y-Axis Chart Format" for="ddlMinorWidth"> Y-Axis Chart Format</label>
                   </td>
            </tr>
            <tr>
    ...
    <div id="divShow" title="Chart Axis and Title Format" onclick="toggleDiv('divFormat', 'img8',340)" style="cursor: pointer;
        background-color: #26B6FB; color: White;">
      ...
      <table summary="This Table Is Used For Select Major/Minor Gridlines/Trickmark,Gridlins Color,Gridline Width,Gridline Interval.">
          <tr>
              <td colspan="2" scope="col" title="MajorGridLine Format" style="text-decoration: underline">
                 <label class="leftLabel" title="MinorGridLine Format" for="ddlMinorWidth"> MinorGridLine Format</label> 
              </td>
          </tr>
            <tr>
          ...
          <tr>
              <td colspan="2" scope="col" title="Minor GridLine Format" style="text-decoration: underline">
                <label class="leftLabel" title="Minor GridLine Format" for="ddlMinorWidth"> MinorGridLine Format</label> 
              </td>
          </tr>
            <tr>
    ...
    <div id="divChartArea" title="ChartArea Format" onclick="toggleDiv('divAreaposition', 'imgChartarea',370)" style="cursor: pointer;
        background-color: #58C7FC; color: White;">
        <table>
            <tr>
                <td scope="col" style="width: 190px" title="Expand/Collapse">
    ...
    <div id="divAreaposition" title="ChartArea Format" style="overflow: hidden; display: none; color:White;">
         <table >
							...
							<tr>
								<td style="width: 110px" >
								    <label for="" title="X Axis" class="leftLabel"><b>X Axis</b></label>
								 </td>
								<td><asp:textbox id="txtX2" runat="server" Width="100px">10</asp:textbox></td>
							</tr>
							<tr>
								<td style="width: 110px" >
								    <label for="" title="Y Axis" class="leftLabel"><b>Y Axis</b></label>
								</td>
							...
							<tr>
								<td style="width: 110px" >
								    <label for="" title="Position" class="leftLabel"><b>Position</b></label>
								</td>
								<td>
                             ...
                             <tr>
                                <td>
                                    <label for="" title="PieCollect" ><b>PieCollect</b></label>
                                </td>
                                <td>
        ...
        <table>
            <tr>
                <td scope="col" style="width: 190px" title="Click Here for Expand/Collapse GridLine Format">
                    <label for="" title="Animation Format" class="leftLabel"><b>Animation Format</b></label>
                </td>
    ...
    <div id="divAnimation" title="Animation Format" style="overflow: hidden; display: none; color:White;">
      <table summary="" style="width: 200px">
           <tr>
				<td ><label for="" title="Legend" class="leftLabel"><b>Legend</b></label></td>
				<td>
		   ...
		   <tr>
								<td> <label for="" title="seriese" class="leftLabel"><b>seriese</b></label></td>
								<td>
									<asp:checkbox id="CheckBoxSeries" runat="server"  Checked="True" Text="Move Series One-By-One" AutoPostBack="false" ></asp:checkbox>
								</td>
							</tr>
		   <tr>
								<td ><label for="" title="Points" class="leftLabel"><b>Points</b></label></td>
								<td>
		   ...
		   <tr>
				<td >
					<label for="" title="Theme" class="leftLabel"><b>Theme</b></label></td>
				<td>
					<p dir="ltr" >
...
<asp:Content ID="mainPane" runat="server" ContentPlaceHolderID="MainPlaceHolder">
   ...
   <div id="divcaption" style="padding:20px;" >
                        ...
                        <table summary="">
                         ...
                         <td valign="top"  scope="col" title="Start Date" style="width:98px"   >
                          ...
                          <td  valign="top" title="End Date" style="width: 78px"  >    
				                <label title="End Date" for="txtTodate" style="color: black">EndDate</label>				                        
				           </td>
        ...
        <div>
            ...
            <td colspan="8" scope="colgroup" title="" align="left" style="width: 594px; color: black;">
        ...
        <tr>
            ...
            <td align="left" colspan="8" scope="colgroup" style="height: 13px; width: 594px;" title=" Click on Graph Button">
            ...
            <%--<input type="button" id="btnopen" onclick="return Opengraph();" class="button" runat="server" name="OpenGraph" title="Click To Open Graph" value="OpenGraph" style="width: 73px" />  --%>
            <asp:Button ID="btnOpenGraph"  runat="server" Text="OpenGraph"  CssClass="button" ToolTip="Click To Open Graph" Width="88px"   />&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td align="left" colspan="8" scope="colgroup" style="width: 594px; height: 13px" title=" Click on Graph Button">
        ...
        <tr>
            <td scope="col" title="Graph On Selected Columns" style="width: 112px">
                ...
                Palette="Kindergarten" Width="400px" Height="400px" >
                <Legends>
                ...
                <Titles>
                    <dcwc:Title Color="DodgerBlue" Font="Microsoft Sans Serif, 9.75pt" Name="Title1" 
                        Style="emboss" Text="Column Chart">
                    </dcwc:Title>
                </Titles>
                 <ChartAreas>
                        ...
                        BorderColor="100, 0, 0, 0" BorderStyle="Solid" Name="Chart Area 1" >
                                ...
                                <AxisY2>
									...
									<AxisX LineColor="64, 64, 64, 64" Interval="1" >
										<LabelStyle Format="# k" ></LabelStyle>
										<MajorGrid LineColor="64, 64, 64, 64"></MajorGrid>
