...
<%@ Page Language="VB"  EnableEventValidation="false" ValidateRequest="false"  EnableViewState="true" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="open_singleuser.aspx.vb" Inherits="GraphicalPresentation_open_singleuser" title="OpenGraph Page" %>
            ...
            <tr>
                <td style="width: 725px" >
                    <div id="Selectreport" runat="server" visible="false">
                        ...
                        <td>
                            <asp:Button ID="getreport" runat="server" Text="Get Report" 
                                CssClass="button" /></td>
                        </td>
                        </tr>
                        <tr>
