...
Imports System.Web
Partial Class GraphicalPresentation_Savegraph_singleuser
    ...
    Protected Sub btnSavenew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSavenew.Click
        ...
        con.Close()
        If gpname = True Then
            graphobj.insertGraph(savegraphtype.Value, 60, 0, 0, savereport.Value, txtGraphname.Text, SelectedColumn.Value, savecolumnseries.Value, DateTo.Value, DateFrom.Value, ll1.Value, leg.Value, ll2.Value, ll.Value, spec.Value, CreatedOn, Save.Value, totalcolumn.Value, Repgraph.Value)
