<%@ Page Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false"
    CodeFile="Welcome.aspx.vb" Inherits="QueryBuilder_Welcome" Title="WelCome" %>
...
//    // {
//     
//    QueryBuilder.chkUserscope(uid, 60,0,0,tabstatus1)
//      }
////    QueryBuilder.Bind_Table(document.getElementById("<%=ddlDept.ClientId%>").value,document.getElementById("<%=ddlClient.ClientId%>").value,document.getElementById("<%=ddlLob.ClientId%>").value,filltable)
//}
function tabstatus1(res)
	{
...
//	 
//	    {
//	    QueryBuilder.tableForlocal(uid, 60,0,0,filltable)
//	    }
//	    else
//	    {
	    QueryBuilder.tableFornonlocal(uid, 60,0,0,filltable)
//	    }
	}
	function tabstatus(res)
	{
 ...
 //var table=document.getElementById("<%=ddlTablename.ClientID%>").value;
	 if (res.value=="Local")
	    ...
	    {
	    QueryBuilder.tableForlocal(uid, document.getElementById("<%=ddlDept.ClientId%>").value,document.getElementById("<%=ddlClient.ClientId%>").value,document.getElementById("<%=ddlLob.ClientId%>").value,filltable)
	    }
	    else
	    {
	    QueryBuilder.tableFornonlocal(uid, document.getElementById("<%=ddlDept.ClientId%>").value,document.getElementById("<%=ddlClient.ClientId%>").value,document.getElementById("<%=ddlLob.ClientId%>").value,filltable)
	    }
	}
...
function FillSavedFormula_single()
{
  ...
  var ll=document.getElementById( "<%=ddlColumn.ClientID%>")
   ...
   //ll.options[0].select=true
    ...
    <table width="100%" border="0" align="center" cellspacing="1" summary="Query Builder">
     <tr>
        <td><%--<input type="button" id="get_tables" runat="server" value="Get Tables" onclick="javascript:getdata1();" visible="false" class="button" />--%></td>
        </tr>

        <tr>
            <td valign="top" width="100%" scope="rowgroup">
<%--<label for="ctl00_LeftPlaceHolder_ddlDept"></label>--%>
                <asp:DropDownList ID="ddlDept" Visible="false" CssClass="leftdropdownlist" Style="width: 190px" runat="server" Width="200px">
                </asp:DropDownList>
                <asp:DropDownList ID="ddlTableName" Visible="false" runat="server" CssClass="leftdropdownlist"  Style="width: 190px">
                </asp:DropDownList>
                <br />
<%--<label for="ctl00_LeftPlaceHolder_ddlClient"></label>--%>
                <asp:DropDownList ID="ddlClient" Visible="false" CssClass="leftdropdownlist" Style="width: 190px"
                    runat="server">
                </asp:DropDownList>
<%--<label for="ctl00_LeftPlaceHolder_ddlLob"></label> --%>
                <select id="ddlLob" runat="server" visible="false" class="leftdropdownlist" style="width: 190px" name="cboLOB">
                </select>
               <%-- <asp:DropDownList ID="ddlLob" runat="server" Visible="false" CssClass="leftdropdownlist" style="width: 190px" name="cboLOB"></asp:DropDownList>--%>
            </td>
        </tr>
        <tr>
        <td>&nbsp;</td>
...
function Button1_singleuser_onclick()
{
    window.open("SavedQueries_singleuser.aspx","SavedQuery","width=600px,height=400px"); 
    //childWindow=open ("SavedQueries.aspx.aspx?cboLOB="+ document.frmquerybl.cboLOB.value+ "&cbodatatable=" + document.frmquerybl.hidtablename.value  ,"open","height=300,width=500,top=100,left=400,scrollbars=yes,location=no,toolbar=0,menubar=0,resizable=0");  
} 
...
function Button3_singleuser_onclick()
{

    window.open("SaveQuery_singleuser.aspx?Dept="+60+"&Client="+0+"&Lob="+0+"&hidtablename="+document.getElementById("hidtablename").value+"&chkPercentage="+document.getElementById("chkPercentage").value+"&hidFormulaName="+document.getElementById("hidFormulaName").value+"&whereData="+document.getElementById("wheredata").value+"&type="+document.getElementById("hidReportmode").value,"SaveQuery_SingleUser","width=600px,height=400px");
    //window.open("SaveQuery.aspx?Dept="+document.getElementById("<%=ddlDept.ClientID%>").value+"&Client="+document.getElementById("<%=ddlClient.ClientID%>").value+"&Lob="+document.getElementById("<%=ddlLob.ClientID%>").value+"&hidtablename="+document.getElementById("hidtablename").value+"&chkPercentage="+document.getElementById("chkPercentage").value+"&hidFormulaName="+document.getElementById("hidFormulaName").value+"&whereData="+document.getElementById("whereData").value+,"SaveQuery","width=600px,height=400px");
}
        ...
        <tr>
           <td style="width: 297px" scope="col"><div id="spanget" style="color:Black; font-weight:bold"></div></td>
            ...
            <td>
                <table>
                    <tr>
                        <td scope="col"><input type="button" value="Share Crosstab" runat="server" id="share" visible="false" class="button" onclick="openSavedQueries1();" /></td>
                        <td scope="col"><input type="button" value="Open Crosstab"  class="button"  id="Button1" runat="server" visible="false" onclick="return Button1_onclick()" /></td>
                         <td scope="col"><%--<input type="button" value="Open Crosstab"  class="button"  id="Button1_singleuser" runat="server" visible="false" onclick="return Button1_singleuser_onclick()" />--%></td>
                        </tr>
                </table>
            </td>
           </tr>
                ...
                <table width="100%" summary="">
                    <tr>
                        <td width="100%" colspan="4" valign="top">
                            <input type="button" value="Process" class="button" onclick="datasubmitt();" id="Button4" style="width: 105px" />
                            <input type="button" value="Reset" class="button" id="Button2" onclick="return Button2_onclick()" style="width: 84px" />
                            <input type="button" value="Save Crosstab" class="button" id="Button3" runat="server" visible="false" onclick="return Button3_onclick()" style="width: 107px" />
                            <%--<input type="button" value="Save Crosstab" class="button" id="Button3_singleuser" runat="server" visible="false" onclick="return Button3_singleuser_onclick()" style="width: 107px" />--%>
