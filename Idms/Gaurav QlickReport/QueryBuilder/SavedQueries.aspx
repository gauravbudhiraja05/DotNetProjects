<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SavedQueries.aspx.vb" Inherits="QueryBuilder_SavedQueries" %>
...
//				window.opener.getdataForSavedQuery();
	window.opener.getspansaved(document.getElementById("hidtablename").value);
			...
			function updateParent_single() {

			    if (document.getElementById("ddlYourQuery_single").selectedIndex == 0 && document.getElementById("ddlQueryName").selectedIndex == 0) {
			        alert("Please select query")
			    }
			    else {
			        ////////////////fill query name////////
			        if (document.getElementById("ddlYourQuery_single").selectedIndex > 0) {
			            window.opener.document.getElementById("queryname").value = document.getElementById("ddlYourQuery_single").value;
			        }
			        else if (document.getElementById("ddlQueryName").selectedIndex > 0) {
			            window.opener.document.getElementById("queryname").value = document.getElementById("ddlQueryName").value;
			        }
	...
	<tr>
	    <td>
	        <table summary="">
	            ...
	            <tr runat="server" id="dept_id" visible="false">
	            ...
	            <tr runat="server" id="client_id" visible="false">
	            ...
	            <tr runat="server" id="lob_id" visible="false">
	            ...
	            <tr runat="server" id="button_id" visible="false">
                    <td align="center" colspan="2"><asp:Button ID="get_query" runat="server" Text="Get Query" CssClass="button"  /></td>                
                </tr>
                <tr runat="server" >
		            <td style="WIDTH: 120px; HEIGHT: 25px"  scope="col"><strong><label for="ddlYourQuery">Your Query</label></strong>&nbsp;</td>
		            <td runat="server" visible="false" id="multi_ddl"  style="HEIGHT: 24px" scope="col"><asp:dropdownlist  CssClass="dropdownlist"  id="ddlYourQuery" runat="server" AutoPostBack="True"></asp:dropdownlist></td>
                    <td runat="server" visible="false" id="single_ddl" style="HEIGHT: 24px" scope="col"><asp:dropdownlist  CssClass="dropdownlist"  id="ddlYourQuery_single" runat="server" AutoPostBack="True"></asp:dropdownlist></td>
	            </tr>
	            <tr runat="server" visible="false">
		            <td style="WIDTH: 120px; HEIGHT: 8px" scope="col" ><strong><label for="ddlQueryName">Shared Queryy</label></strong>&nbsp;</td>
		            <td style="HEIGHT: 24px" scope="col"><asp:dropdownlist  CssClass="dropdownlist"  id="ddlQueryName" runat="server" AutoPostBack="True"></asp:dropdownlist></td>
	            </tr>   
            ...
            <table summary="" >
                <tr>
		            <td style="HEIGHT: 4px" align="center" scope="col"><br />
			            <input class="button" runat="server" visible="false" onclick="return updateParent();" type="button" value="Submit" id="Button1" /><input 
                            class="button" runat="server" visible="false" onclick="return updateParent_single();" type="button" value="Submit" 
                            id="Button1_single" />
			            <asp:button id="cmddelete" Visible="False" CssClass="button" Text="Delete" Runat="server"></asp:button>
			            <asp:button id="cmddelete_single" Visible="False" CssClass="button" 
                            Text="Delete" Runat="server"></asp:button>
