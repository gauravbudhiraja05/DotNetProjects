<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SaveQuery.aspx.vb" Inherits="QueryBuilder_SaveQuery" %>
				...
				<tr>
				    <td scope="col">
				        ...
				        <caption class="caption" style="background-color:#0591d3">Save Or Update Query</caption>
				            ...
				            <tr visible="false" runat="server" id="dept_id" >
				            ...
				            <tr visible="false"  runat="server" id="client_id">
				            ...
				            <tr visible="false" runat="server" id="lob_id">
				            ...
				            <tr>
					            <td align="center" colspan="2"><br/>
						            <input class="button" id="Button1" type="button" value="Save New" name="Button1" runat="server" visible="false" />
                                    <input class="button" id="Button1_single" type="button" value="Save New" name="Button1_single" runat="server" visible="false" />&nbsp;
                                    <input class="button" id="Button2" visible="false" type="button" value="Update" name="Button2" runat="server" /><input 
                                        class="button" id="Button2_single" visible="false" type="button" value="Update" name="Button2_single" 
                                        runat="server" />
						            <asp:button id="cmdclose" Runat="server" Text="Close" CssClass="button"></asp:button><BR>
					            </td>
				            </tr>
				        </table>
				    </td>
