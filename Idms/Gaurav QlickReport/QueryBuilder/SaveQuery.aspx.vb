...
#Region " Control Event"
    ...
    Protected Sub Button1_ServerClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.ServerClick
        ...
        'End If
        Dim cmdsave As New SqlCommand("select queryname from WARSQueryMaster where tablename='" & Trim(Request("hidtablename")) & "' and savedby='" & Session("userid") & "' and queryname='" & Trim(Request("sfilename")) & "' and lobyname='" & lob & "' and DepartmentId='" & cbodept.Text & "' and ClientId='" & client & "'", connectionsave)
        ...
        If rdrsave.Read Then
            ...
            Exit Sub
        Else
            Session("mailtain") = statuschk + "," + cbodept.Text.ToString
            ...
            With objcmd.Parameters
                ...
                .AddWithValue("@sharedwith", Session("username"))
                .AddWithValue("@Formulaname", hidforname.Value)
                .AddWithValue("@Percentage", chkper.Value)
                .AddWithValue("@DepartmentId", cbodept.Text)
                .AddWithValue("@ClientId", client)
                .AddWithValue("@lobyName", lob)
                .AddWithValue("@removesharing", "NULL")
                .AddWithValue("@status ", "Non Local")
            ...
            Dim cmdsave1 As New SqlCommand("select queryname from WARSQueryMaster where tablename='" & Trim(Request("hidtablename")) & "' and savedby='" & Session("userid") & "' and queryname='" & Trim(Request("sfilename")) & "' and lobyname='" & lob & "' and DepartmentId='" & cbodept.Text & "' and ClientId='" & client & "'", connectionsave1)
        ...
        winclose()
    End Sub
    Protected Sub Button1_single_ServerClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1_single.ServerClick
        If Session("mailtain") <> "" Then
            Dim recid As String = ""

            If LCase(owner.Value) <> LCase(Session("userid")) Then
                Dim cmdne As New SqlDataAdapter("select recordid from WARSQueryMaster where queryname='" + q.Value + "' and departmentid='60' and clientid='0' and lobyname='0'", connection)
                Dim dsss As New DataSet
                cmdne.Fill(dsss)
                recid = dsss.Tables(0).Rows(0)(0).ToString
                cmdne.Dispose()
        ...
        Session("mailtain") = ""
        If sfilename.Text = "" Then
            ShowConfirm("Please Enter Report Name First")
            Exit Sub
        End If
        Dim statuschk As String = ""
        'If chkstatus.Checked = True Then
        ...
        'End If
        Dim cmdsave As New SqlCommand("select queryname from WARSQueryMaster where tablename='" & Trim(Request("hidtablename")) & "' and savedby='" & Session("userid") & "' and queryname='" & Trim(Request("sfilename")) & "' and lobyname='0' and DepartmentId='60' and ClientId='0'", connectionsave)
        Dim rdrsave As SqlDataReader
        connectionsave.Open()
        rdrsave = cmdsave.ExecuteReader
        If rdrsave.Read Then
        ...
        Else
            ...
            '*************************************************changes made by vini********************************************************************
            '************************inserting subheading into database********************************************************************
            Dim cmdsave1 As New SqlCommand("select queryname from WARSQueryMaster where tablename='" & Trim(Request("hidtablename")) & "' and savedby='" & Session("userid") & "' and queryname='" & Trim(Request("sfilename")) & "' and lobyname='0' and DepartmentId='60' and ClientId='0'", connectionsave1)
            Dim rdrsave1 As SqlDataReader
            connectionsave1.Open()
            rdrsave1 = cmdsave1.ExecuteReader
            If rdrsave1.Read Then
    ...
    Protected Sub Button2_ServerClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.ServerClick
        ...
        End If
        If cbodept.Text = "--Select--" Then
            ShowConfirm("No department has been selected")
        End If
        Session("mailtain") = ""
        Dim statuschk As String = ""
        'If chkstatus.Checked = True Then
        ...
        Else
            lob = cbolob.Text
        End If
        Dim cmd As New SqlDataAdapter("select  * from WARSQueryMaster where tablename='" & Trim(Request("hidtablename")) & "' and savedby='" & Session("userid") & "' and queryname='" & Trim(Request("sfilename")) & "' and lobyname='" & lob & "' and DepartmentId='" & cbodept.Text & "' and ClientId='" & client & "'", connection)
        ...
        Dim updatecmd As New SqlCommand("Update WARSQueryMaster set wheredata=@wheredata,wheredata1= '" & WhereData1.Value & "' , showData= '" & sdata.Value & "', colName='" & Column.Value & "', selected_field='', formula='" & txtformula.Value & "',  createDate='" & dt & "',  sharedwith='" & str & "', Percentage='" & chkper.Value & "', crdata='" & crdata.Value & "', Formulaname='" & hidforname.Value & "',status='" + statuschk + "' where tablename='" & Trim(Request("hidtablename")) & "' and savedby='" & Session("userid") & "' and queryname='" & Trim(Request("sfilename")) & "' and lobyname='" & lob & "' and DepartmentId='" & cbodept.Text & "' and ClientId='" & client & "'", connection)
        ...
        ' Dim str1 = objQB.trackQ_BuilderForMaster(Session("userid"), "Update", "Query", Trim(Request("sfilename")), Trim(Request("hidtablename")), cbodept.Text, client, lob)
        ...
        winclose()
    End Sub
    Protected Sub Button2_single_ServerClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2_single.ServerClick
        If Session("mailtain") <> "" Then
            Dim recid As String = ""
        ...
        End If
        If sfilename.Text = "" Then
            ShowConfirm("Please Enter Query Name First")
        End If
        Session("mailtain") = ""
        Dim statuschk As String = ""
        'If chkstatus.Checked = True Then
        ...
        'lob = cbolob.Text
        'End If
        Dim cmd As New SqlDataAdapter("select  * from WARSQueryMaster where tablename='" & Trim(Request("hidtablename")) & "' and savedby='" & Session("userid") & "' and queryname='" & Trim(Request("sfilename")) & "' and lobyname='0' and DepartmentId='60' and ClientId='0'", connection)
        Dim setdata As New DataSet
        cmd.Fill(setdata)
        If setdata.Tables(0).Rows.Count > 0 Then
        ...
        Dim dt As String = ""
        dt = System.DateTime.Now.ToString
        Dim updatecmd As New SqlCommand("Update WARSQueryMaster set wheredata=@wheredata,wheredata1= '" & WhereData1.Value & "' , showData= '" & sdata.Value & "', colName='" & Column.Value & "', selected_field='', formula='" & txtformula.Value & "',  createDate='" & dt & "',  sharedwith='" & str & "', Percentage='" & chkper.Value & "', crdata='" & crdata.Value & "', Formulaname='" & hidforname.Value & "',status='" + statuschk + "' where tablename='" & Trim(Request("hidtablename")) & "' and savedby='" & Session("userid") & "' and queryname='" & Trim(Request("sfilename")) & "' and lobyname='0' and DepartmentId='60' and ClientId='0'", connection)
        updatecmd.Parameters.AddWithValue("@wheredata", WhereData.Value)
        connection.Open()
        updatecmd.ExecuteNonQuery()
        connection.Close()
