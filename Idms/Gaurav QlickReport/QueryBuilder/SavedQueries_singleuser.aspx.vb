...
Imports System.Data
Partial Class QueryBuilder_SavedQueries_singleuser
    ...
    Protected Sub ddlYourQuery_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlYourQuery.SelectedIndexChanged
        Try
            ...
            'Response.End()
            cmd.CommandText = "select * from warsquerymaster where DepartmentId='60' and ClientId='0' and lobyname='0' and queryname = '" & ddlYourQuery.SelectedItem.Text & "' order by queryName"
            con.Open()
            dr = cmd.ExecuteReader
            While dr.Read = True
                chkPercentage.Value = dr("Percentage").ToString
            ...
            con.Close()
            cmd.Dispose()
            Session("mailtain") = Session("mailtain") + ",60,0,0" + ddlYourQuery.SelectedItem.Text
            'Else
            cmddelete.Visible = True
            'End If
    ...
    Protected Sub cmddelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmddelete.Click
        ...
        connection.Open()
        Dim cmd As SqlCommand = New SqlCommand("select tablename from WARSQueryMaster where queryname='" + ddlYourQuery.SelectedItem.Text + "' and departmentid='60' and clientid='0' and lobyname='0'", connection)
        ...
        Try
            ...
            If Session("usertype") = "superadmin" Then
                ...
                'Dim str1 = objQB.trackQ_BuilderForMaster(Session("userid"), "Delete", "Query", ddlYourQuery.SelectedItem.Text, tablename, dept, client, lob)
            ...
            Else
                ...
                '''''''''''''''Usertype check for track goes here:- By Suvidha
                Dim objQB As New QueryBuilder()
                'Dim str1 = objQB.trackQ_BuilderForMaster(Session("userid"), "Delete", "Query", q_name, tablename, dept, client, lob)
                connection.Close()
        ...
        Try
            ...
            If (Session("typeofuser") = "Admin") Then
                ...
                If readerdata.HasRows Then
                    qstr = "select queryName from warsquerymaster where DepartmentId='60' and ClientId='0' and lobyname='0' order by queryName"
                Else
                    qstr = "select queryName from warsquerymaster where DepartmentId='60' and ClientId='0' and lobyname='0' and savedby='" + Session("userid") + "' order by queryName"
            ...
            Else
                ...
                If (scope = "Local") Then
                    qstr = "select queryName from warsquerymaster where DepartmentId='0' and ClientId='0' and lobyname='0' and (status='Local' or savedby='" + Session("userid") + "') order by queryName"
