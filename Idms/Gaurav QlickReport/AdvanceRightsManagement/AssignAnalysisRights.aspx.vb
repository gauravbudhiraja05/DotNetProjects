...
Partial Class AdvanceRightsManagement_AssignAnalysisRights
    ...
    Public Sub ClearAll()
        ...
        ddlClientanalysis.ClearSelection()
        ddlLobAnalysis.ClearSelection()
        'gvUsers.Visible = False
        gvUsers.DataSource = Nothing
        gvUsers.DataBind()
        'gvAnalysis.Visible = False
        gvAnalysis.DataSource = Nothing
        gvAnalysis.DataBind()
        'ddlDepartment.SelectedIndex = 0
        ddlDepartment.ClearSelection()
        'ddlDepartmentAnalysis.SelectedIndex = 0
        ddlDepartmentAnalysis.ClearSelection()
