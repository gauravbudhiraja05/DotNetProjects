...
Public Class ReportDesigner
    ...
    ''' <remarks></remarks>
    Public Function fetchReportRecordid2(ByVal repname As String, ByVal deptid As Integer, ByVal clientid As Integer, ByVal lobid As Integer) As String
        cmd = New SqlCommand("sp_reportRecordid2", con)
        cmd.CommandType = CommandType.StoredProcedure
        ...
        Return str
    End Function
    Public Function insertReport2(ByVal QueryName As String, ByVal DepartmentID As String, ByVal ClientID As String, ByVal UnderLOB As String, ByVal TableName As String, ByVal HeaderID As String, ByVal FooterID As String, ByVal ColName As String, ByVal FormulaName As String, ByVal TxtFormula As String, ByVal WhereData As String, ByVal GroupBy As String, ByVal OrderBy As String, ByVal HavingCondition As String, ByVal ReportFormat As String, ByVal ColorCondition As String, ByVal ReportType As String, ByVal ReportScope As String, ByVal DateConTable As String, ByVal CreatedOn As String, ByVal SavedBy As String, ByVal columnFormat As String, ByVal level As String) As String
        Dim res As String
        res = ""
        Try
            cmd = New SqlCommand("sp_SaveReport2", con)
            cmd.CommandType = CommandType.StoredProcedure
            ...
            cmd.Parameters.Add("@ReportScope", SqlDbType.VarChar, 50)
            cmd.Parameters("@ReportScope").Value = ReportScope
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function CheckExistingReport2(ByVal repname As String, ByVal deptid As String, ByVal clientid As String, ByVal lobid As String) As String
        Dim stat As String = ""
        stat = False
        cmd = New SqlCommand("Select savedby from IDMSreportMaster where queryname='" + repname + "' and departmentid='" + deptid + "' and clientid='" + clientid + "' and underlob='" + lobid + "' and savedby<>'Deleted' and archivedstatus <>'Yes'", con)
        con.Open()
    ...
    Public Function insertHTMLReport(ByVal repName As String, ByVal Path As String, ByVal SavedBy As String, ByVal SavedOn As String, ByVal Type As String, ByVal queryname As String) As String
        ...
        Return res
    End Function
    Public Function reportArchiveForMul(ByVal user As String, ByVal cudate As String, ByVal repname As String, ByVal deptid As String, ByVal clientid As String, ByVal lobid As String)
        Dim res As String
        res = ""
        Try
            cmd = New SqlCommand("sp_archiveReportForMul", con)
            cmd.CommandType = CommandType.StoredProcedure
            cmd.Parameters.Add("@SavedBy", SqlDbType.VarChar, 200)
            ...
            cmd.Parameters("@ClientId").Value = clientid
            cmd.Parameters.Add("@UnderLob", SqlDbType.VarChar, 9)
            cmd.Parameters("@UnderLob").Value = lobid
            con.Open()
            cmd.ExecuteNonQuery()
            con.Close()
            res = "1"
    ...
    Public Function reportFornonlocal(ByVal user As String)
        ...
        Return ds
    End Function
    Public Function reportFornonlocalMulUser(ByVal user As String, ByVal deptid As String, ByVal clientid As String, ByVal lobid As String)
        ds.Clear()
        cmd = New SqlCommand("sp_reportFornonlocal", con)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add("@userid", SqlDbType.VarChar, 200)
    ...
    Public Function tableFornonlocal(ByVal user As String)
        ...
        Return ds
    End Function
    Public Function tableFornonlocal2(ByVal user As String, ByVal deptid As String, ByVal clientid As String, ByVal lobid As String)
        ds.Clear()
        cmd = New SqlCommand("sp_tableFornonlocal2", con)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add("@userid", SqlDbType.VarChar, 200)
        cmd.Parameters("@userid").Value = user
        cmd.Parameters.Add("@deptid", SqlDbType.VarChar, 50)
        ...
        Return ds
    End Function
    Public Function tableFortempimport(ByVal user As String)
        ds.Clear()
        cmd = New SqlCommand("sp_tableFortempimport", con)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add("@userid", SqlDbType.VarChar, 200)
        cmd.Parameters("@userid").Value = user
        con.Open()
    ...
    Public Function reportForuserForMul(ByVal userid As String, ByVal deptid As String, ByVal clientid As String, ByVal lobid As String)
        ds.Clear()
        cmd = New SqlCommand("sp_reportForuserForMul", con)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add("@userid", SqlDbType.VarChar, 200)
        cmd.Parameters("@userid").Value = userid
        cmd.Parameters.Add("@deptid", SqlDbType.VarChar, 50)
