...
Public Class Library
    Public Function checkAlphabetic(ByVal input As String)
        ...
        For count = 1 To input.Length
            If Not (Asc(Mid(input, count, 1)) >= 65 And Asc(Mid(input, count, 1)) <= 90 Or Asc(Mid(input, count, 1)) >= 95 And Asc(Mid(input, count, 1)) <= 122) Or Asc(Mid(input, count, 1)) = 32 Then
                Return False
            End If
        Next
        Return True
