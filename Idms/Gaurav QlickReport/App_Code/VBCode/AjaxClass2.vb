...
Public Class AjaxClass2
    ...
    <Ajax.AjaxMethod()> Public Function Show(ByVal Process As String, ByVal LOB As String, ByVal CBOADD As String) As String
        ...
        Dim bx1 As String
        Dim rdrtarge
        Dim commId1 As New SqlCommand("select distinct Target from IDMSAddition_Prodn_Vol where ProcessName='" + Process + "' and LOBName='" + LOB + "' and additional_vol_by='" + CBOADD + "' and (Target is not null)", connection)
    ...
    <Ajax.AjaxMethod()> Public Function SavePro(ByVal Process As String, ByVal Description As String, ByVal userid As String) As String
        Dim msg As String
        Dim bx1 As String
        Try
            '*********************************checking duplicacy for process 18/10/07 ****************
            Dim cmdcheck As SqlCommand = New SqlCommand(" select Process from bltprocess where Process= '" & Process & "'", conn1)
            conn1.Open()
            Dim dr As SqlDataReader
            dr = cmdcheck.ExecuteReader

            If dr.Read Then
                'Dim processname = dr("Process")
                msg = "This Process Already Exists Please Enter Another Process"
                Return (msg)
    ...
    End Function
    <Ajax.AjaxMethod()> Public Function SaveLob(ByVal ProcessId As String, ByVal Lob As String, ByVal Description As String, ByVal userid As String) As String
        Dim msg As String
        Try

            Dim cmdcheck As SqlCommand = New SqlCommand(" select Lob from bltlob where ProcessId  = '" & ProcessId & "'and Lob='" & Lob & "'", conn1)
            conn1.Open()
            Dim dr As SqlDataReader
            dr = cmdcheck.ExecuteReader
            ...
            If dr.Read Then
                'Dim processname = dr("Lob")
                msg = "This LOB Already Exists For Selected Process!! Please Enter Another LOB"
                Return (msg)
        ...
        End Try
    End Function
    <AjaxPro.AjaxMethod()> Public Function AddItemList(ByVal struserid) As String
        Dim i As Integer = 0
        ...
        Return Trim(strPWD)
    End Function
    <AjaxPro.AjaxMethod()> Public Function BindCombo(ByVal struserid) As String
        Dim i As Integer = 0
        ...
        Return Trim(strname)
    End Function
    <AjaxPro.AjaxMethod()> Public Function bindtable(ByVal LOBId) As String
    ...
    End Function
    <AjaxPro.AjaxMethod()> Public Function bindlobtable(ByVal id) As String
        'Show the table name 
    ...
    <AjaxPro.AjaxMethod()> Public Function bindlobField(ByVal tablename) As String
        Dim lobfield As String
    ...
    <AjaxPro.AjaxMethod()> Public Function chk(ByVal BatchName, ByVal Month, ByVal Year) As String
        Dim bx As String
        ...
        Return (bx)
    End Function
    <AjaxPro.AjaxMethod()> Public Function drop(ByVal BatchName, ByVal Month, ByVal Year, ByVal update) As String
        Dim var As String
    ...
    <AjaxPro.AjaxMethod()> Public Function takevalue1(ByVal Month, ByVal Year) As Integer
        Dim bx1 As Integer
        Dim ds3 As New DataSet
    ...
    <AjaxPro.AjaxMethod()> Public Function saveworkingdays(ByVal Month, ByVal Year, ByVal week_days, ByVal saturday, ByVal daksh_holiday, ByVal Training_Hrs, ByVal leaves, ByVal HrsOfProduction, ByVal productionhours, ByVal Userid) As String
        Dim msg As String
        Dim bx1 As String
        Dim str1 As String
        ...
        Dim commId1 As New SqlCommand("select distinct Month,YEAR from IDMS_workingdays where Month = '" + Month + "' AND YEAR = " + Year + " ", connection)
        Dim rdrId1 As SqlDataReader
        connection.Open()
        rdrId1 = commId1.ExecuteReader
    ...
    <AjaxPro.AjaxMethod()> Public Function bindmonth(ByVal batchname) As String
        ...
        Return (strname)
    End Function
    <AjaxPro.AjaxMethod()> Public Function bindyear(ByVal batchname) As String
        Dim i As Integer = 0
        Dim strname As String = ""
    ...
    End Function
    <AjaxPro.AjaxMethod()> Public Function savecph(ByVal BatchName, ByVal Month, ByVal Year, ByVal Actual, ByVal Userid) As String
        Dim msg As String
        Dim bx As String
        Dim bx1 As String
    ...
    <Ajax.AjaxMethod()> Public Function save2(ByVal Process As String, ByVal LOB As String, ByVal Month As String, ByVal Year As Integer, ByVal volname As String, ByVal volprod As Integer, ByVal HeadCount As Integer, ByVal strTarget As Integer, ByVal Userid As String) As String
        Dim msg As String
        Dim bx1 As String
        'Dim commId1 As New SqlCommand("select distinct Month,YEAR,Additional_Vol_by from IDMSAddition_Prodn_Vol where LOBName='" + LOB + "' and ProcessName='" + Process + "' and Month = '" + Month + "' AND YEAR = " + Year + " AND Additional_Vol_by = '" + volname + "' order by month,year", connection)

        Dim commId1 As New SqlCommand("select distinct Month,YEAR,Additional_Vol_by from IDMSAddition_Prodn_Vol where LOBName='" + LOB + "'  and ProcessName ='" + Process + "' and Month = '" + Month + "'AND Additional_Vol_by = '" + volname + "'AND YEAR = '" + Year.ToString() + "' order by month,year ", connection)
        Dim rdrId1 As SqlDataReader
        connection.Open()
        rdrId1 = commId1.ExecuteReader
        ...
        Else
            Try
                Dim cmdinsert As SqlCommand = New SqlCommand("insert_IDMSAddition_Prodn_Vol2", connection)
                cmdinsert.CommandType = CommandType.StoredProcedure
                With cmdinsert.Parameters()
                    .Add("@Month", Trim(Month))
                    .Add("@Year", CType(Year, Integer))
        ...
        End If
    End Function
    <AjaxPro.AjaxMethod()> Public Function Target(ByVal Process, ByVal LOB) As String
        Dim msg As String
        Dim bx1 As String
        Dim rdrtarge
    ...
    <Ajax.AjaxMethod()> Public Function saveActualProduction(ByVal Process As String, ByVal LOB As String, ByVal Month As Integer, ByVal Year As Integer, ByVal volprod As Integer, ByVal Userid As String) As String
        Dim msg As String
        Dim bx1 As String

        Try
            Dim cmdCheck As New SqlCommand("select Month,YEAR from IDMSActual_Prodn_Vol where LOBName='" + LOB + "' and ProcessName='" + Process + "' and Month = '" + Month.ToString() + "' AND YEAR = '" + Year.ToString() + "'  order by month,year", connection)

            '  Dim cmdCheck As New SqlCommand("select distinct Month,YEAR from IDMSActual_Prodn_Vol where LOBName='" + LOB + "' and ProcessName='" + Process + "' and Month = '" + Month + "' AND YEAR = '" + Year + "'  order by month,year", connection)
            'Dim cmdCheck As SqlCommand = New SqlCommand("select distinct Month,YEAR from IDMSActual_Prodn_Vol where LOBName='" + LOB + "' and ProcessName='" + Process + "' and Month = '" + Month + "' AND YEAR = '" + Year + "'  order by month,year", connection)

            Dim rdrId1 As SqlDataReader
            connection.Open()
            rdrId1 = cmdCheck.ExecuteReader
            If rdrId1.Read Then
                bx1 = "T"
            Else
                bx1 = "F"
            ...
            If bx1 = "T" Then
                Try
                    Dim cmdUpdate As SqlCommand = New SqlCommand("Update_IDMSActualProductionVolume", connection)
            ...
            Else
                Try
                    Dim cmdinsert As SqlCommand = New SqlCommand("insert_IDMSActualProductionVolume", connection)
                    cmdinsert.CommandType = CommandType.StoredProcedure
                    With cmdinsert.Parameters()
                        .Add("@Month", Trim(Month))
                        .Add("@Year", CType(Year, Integer))
        ...
        End Try
    End Function
    <AjaxPro.AjaxMethod()> Public Function save1(ByVal BatchName, ByVal Month, ByVal Year, ByVal atteration, ByVal Userid) As String
        Dim msg As String
        Dim bx As String
        Dim bx1 As String
        ...
        End If
    End Function
    <AjaxPro.AjaxMethod()> Public Function getmonth(ByVal intmonth) As String
        ...
        Return month1
    End Function
    <AjaxPro.AjaxMethod()> Public Function findpreviousmonth(ByVal Batch) As Decimal
