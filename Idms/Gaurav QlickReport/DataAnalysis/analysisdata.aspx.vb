...
Partial Class analysisdata
    ...
    Dim havingcondition, formula As String
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If rdr.Read Then
            ...
            If (producttype = "Multiple User") Then
                ...
                client_row1.Visible = True
                lob_row1.Visible = True
                ...
                If (dsar.Tables(0).Rows.Count > 0) Then
                    ...
                    lbldept1.Text = dsar.Tables(0).Rows(0)("MenuDescription").ToString()
                    lblclient2.Text = dsar.Tables(0).Rows(1)("MenuDescription").ToString()
                    lbllob2.Text = dsar.Tables(0).Rows(2)("MenuDescription").ToString()
                End If
    ...
    Protected Sub ddlReport_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlTable.SelectedIndexChanged
        getcols_report.Visible = False
        getcols_table.Visible = False
        repcols.Items.Clear()
        selectedcols.Items.Clear()
        If (report_radio.Checked = True) Then
            getcols_report.Visible = True
        ElseIf (table_radio.Checked = True) Then
            getcols_table.Visible = True
        End If
        'Session("maxval1") = ""
        'Session("maxval") = ""
        ''Divhead.InnerHtml = ""
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button3.Click
        con.Close()
        If (report_radio.Checked = True) Then
            cmd = New SqlCommand("select tablename from IDMSReportMaster where QueryName='" + ddlTable.SelectedItem.Text + "'", con)
            con.Open()
            Dim str As String = cmd.ExecuteScalar().ToString()
            table = str
        ElseIf (table_radio.Checked = True) Then
            table = ddlTable.SelectedItem.Text
        End If
        If selectedcols.Items.Count = 0 Then
    ...
    Protected Sub level1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DepartmentName.SelectedIndexChanged
        ...
        Else
            ...
            clientid = 0
            lobid = 0
            If (table_radio.Checked = True) Then
                ddltable_bind(deptid, clientid, lobid)
            ElseIf (report_radio.Checked = True) Then
                ddlReport_bind(deptid, clientid, lobid)
            End If
            ddlTable.Visible = True
            select_l1.Visible = True
        End If
    End Sub
    ...
    Protected Sub level3_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlLobName.SelectedIndexChanged
        ...
        ddlTable.Items.Clear()
        If ddlLobName.SelectedItem.Text = "--Select--" Or ddlLobName.SelectedValue = "" Then
            ddlTable.Items.Clear()
            deptid = DepartmentName.SelectedValue
            clientid = ClientName.SelectedValue
            lobid = 0
        ...
        End If
    End Sub
    Public Function ddltable_bind(ByVal deptid As String, ByVal clientid As String, ByVal lobid As String)
        con.Close()
        con.Open()
        ddlTable.Items.Clear()
    ...
    End Function
    Public Function ddlReport_bind(ByVal deptid As String, ByVal clientid As String, ByVal lobid As String)
        con.Close()
        con.Open()
        ddlTable.Items.Clear()
    ...
    Protected Sub Gettable_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Gettable.Click
        ...
        ddlTable.DataBind()
        ddlTable.Items.Insert(0, "--Select--")
        getcols_table_single.Visible = True
    End Sub
    ...
    Protected Sub SAVE_multiuser_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SAVE_multiuser.Click
        ...
        If DropDownclient.SelectedItem.Text = "--Select--" Then
            ...
            clientname = ""
        Else
            clientval = DropDownclient.SelectedValue
            clientname = DropDownclient.SelectedItem.Text
            'DropDownlob.SelectedItem.Text = "0"
            'lobval = "0"
        End If

        If DropDownlob.SelectedValue = "--Select--" Or DropDownlob.SelectedValue = "" Then
            'DropDownlob.SelectedItem.Text = "0"
            lobval = "0"
            lobname = ""
        Else
            lobval = DropDownlob.SelectedValue
            lobname = DropDownlob.SelectedItem.Text
        End If
        Dim localstatus As String = ""
        'If chklocal.Checked = True Then
        'localstatus = "Local"
        ...
        cmd.Parameters("@ClientId").Value = clientval
        cmd.Parameters.Add("@LobName", SqlDbType.VarChar, 50)
        cmd.Parameters("@LobName").Value = lobname
        cmd.Parameters.Add("@LobId", SqlDbType.VarChar, 50)
        cmd.Parameters("@LobId").Value = lobval
        cmd.Parameters.Add("@ReportName", SqlDbType.VarChar, 50)
        cmd.Parameters("@ReportName").Value = textreportname.Text
    ...
    Protected Sub table_radio_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles table_radio.CheckedChanged
        getcols_report_single.Visible = False
        getcols_table_single.Visible = False
        ddlTable.Visible = False
        select_l1.Visible = False
        selectedcols.Items.Clear()
        repcols.Items.Clear()
        Gettable.Visible = False
        ...
        Else
        Gettable.Visible = True
        GetReport.Visible = False
        End If
        select_l1.Text = "Select Table"
    End Sub

    Protected Sub report_radio_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles report_radio.CheckedChanged
        getcols_report_single.Visible = False
        getcols_table_single.Visible = False
        ddlTable.Visible = False
        select_l1.Visible = False
    ...
    Protected Sub GetReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles GetReport.Click
        ...
        select_l1.Visible = True
        ddlTable.Items.Clear()
        Dim cmdgettable As New SqlCommand("select Recordid,QueryName from Idmsreportmaster where DepartmentID='60' and ClientID='0' and UnderLOB='0' and SavedBy='" + Session("userid").ToString() + "' ", connection)
        Dim dsgettable As New DataSet
        Dim adpgettable As New SqlDataAdapter
        adpgettable.SelectCommand = cmdgettable
        connection.Open()
        ...
        ddlTable.DataBind()
        ddlTable.Items.Insert(0, "--Select--")
        getcols_report_single.Visible = True
    End Sub

    Protected Sub getcols_report_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles getcols_report.Click
        If (ddlTable.SelectedItem.Text = "--select--") Then
    ...
    Public Sub gridreportbind1()
        ...
        '  End If
    End Sub
    Protected Sub getcols_table_single_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles getcols_table_single.Click
        If (ddlTable.SelectedIndex = 0) Then
            aspnet_msgbox("Please Select Table Name First")
            Exit Sub
        Else
            con.Close()
            con.Open()
            Dim com1 As New SqlCommand("select Visiblecolumn from WARSLOBTableMaster where DepartmentId='60' and ClientId='0' and LOBId='0' and CreatedBy='" + Session("userid") + "' and  TableName='" + ddlTable.SelectedItem.Text + "'", con)
            readquery1 = com1.ExecuteReader
            While readquery1.Read()
                colname = readquery1("Visiblecolumn")
    ...
    Protected Sub getcols_report_single_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles getcols_report_single.Click
        If (ddlTable.SelectedIndex = 0) Then
            aspnet_msgbox("Please Select Report Name First")
            Exit Sub
        Else
            Dim dept, client, lob As String
            'dept = DepartmentName.SelectedValue
