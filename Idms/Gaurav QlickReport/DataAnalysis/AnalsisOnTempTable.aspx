<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AnalsisOnTempTable.aspx.vb" Inherits="DataAnalysis_AnalsisOnTempTable" %>
...
<body>
    <form id="form1" runat="server">
     <div style="padding:20px;"> 
       ...
       <caption class="caption" style ="background-color:#67A897" >Select Temporary Table</caption>
             <%--
---------------- Change History -------------------------
none
--%><%--</td></tr></table>
 ...
 --%>
            ...
            <tr>
                <td style="width:200px"><asp:Label ID="Label1" CssClass="label" runat="server" Text="Selected Temporary Table " ></asp:Label> </td>
                <td><asp:Label ID="lblselect" CssClass="label" ForeColor="Red" runat="server"></asp:Label> </td>
            </tr>       
...
--%>
 ...
 --%>
            ...
            <tr><td><asp:Button csc="button" Visible="false"   ID="SAVE_singleuser" runat="server" Text="SAVE" 
                    CssClass="button "/>&nbsp;<asp:Button csc="button" ID="SAVE_multiuser" 
                    runat="server" Text="SAVE" Visible="false"   CssClass="button "/></td></tr>
            </table>
