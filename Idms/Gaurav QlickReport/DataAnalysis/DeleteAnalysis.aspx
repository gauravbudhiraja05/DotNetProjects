...
<link rel="stylesheet" type="text/css" href="../App_Themes/Themes/StyleSheet.css" />
    ...
    <table summary="Select Analysis">
        <caption class="caption" style ="background-color:#67A897; width: 848px;">
            SELECT ANALYSIS
        </caption>
        <%-- <td scope="col" style="width: 40px">
    ...
    <td style="width: 174px; height: 24px;"><asp:DropDownList ID="ddlReport" runat="server"> 
            ...
            <tr runat="server" id="dept_row" visible="false">
                   <td align="center"><%-- <label class="label" title="Select Report" id="Label1" runat="server" for="ctl00_MainPlaceHolder_ddlReport">Select Level1</label>--%> 
            ...
            <tr runat="server" id="client_row" visible="false">
                  <td align="center"><%--<label class="label" title="Select Report" id="Label2" runat="server" for="ctl00_MainPlaceHolder_ddlReport">Select Level2</label>--%> 
            ...
            <tr runat="server" id="lob_row" visible="false">
                 <td align="center"><%--<label class="label" title="Select Report" id="Label3" runat="server" for="ctl00_MainPlaceHolder_ddlReport">Select Level3</label>--%> 
           ...
           <tr runat="server" id="button_row" visible="false">
            <td align="center" colspan="2">
                <asp:Button ID="getanalysis_singleuser" runat="server" CssClass="button" 
                    Text="Get Html Report"/>
                </td>
                </tr>
                <tr><td colspan="2"></td></tr>
                <tr><td colspan="2"></td></tr>
                <tr>
            <td align="center" scope="col" style="width: 141px; color :Black ">
        ...
        --%>
            ...
            <td>
                <br />
                <br />
                <asp:Button ID="ShowReport" runat="server" CssClass="button" Text="Delete Html Report" 
                    ToolTip="Show Report" />
            </td>
        </tr>
    </table>
