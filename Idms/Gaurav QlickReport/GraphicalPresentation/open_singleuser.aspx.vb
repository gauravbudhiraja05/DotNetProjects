...
Partial Class GraphicalPresentation_open_singleuser
    ...
    Public Sub openExistgraph1()
        ...
        Try
            ...
            If txtCurrentReport.Text <> "" Then
                ...
                hidlob = 0
                repName = txtCurrentReport.Text
                sqlString = "Select idmsgraphmaster.Graphtype,idmsgraphmaster.Departmentid,idmsgraphmaster.Clientid,idmsgraphmaster.underlob,idmsgraphmaster.Queryname,idmsgraphmaster.columnname,idmsgraphmaster.graphtype,idmsgraphmaster.columnseries,idmsgraphmaster.todate,idmsgraphmaster.fromdate,idmsgraphmaster.commanformat1,idmsgraphmaster.commanformat2,idmsgraphmaster.commanformat,idmsgraphmaster.specificproperties,idmsgraphmaster.totalcolumn from idmsgraphmaster where  idmsgraphmaster.graphname='" + ddlgraphname.SelectedItem.Text + "' and idmsgraphmaster.departmentid='60' and idmsgraphmaster.clientid='0' and idmsgraphmaster.underlob='0'"
            Else
                dept = 60
                client = 0
                lob = 0
                sqlString = "Select idmsgraphmaster.Graphtype,idmsgraphmaster.Departmentid,idmsgraphmaster.Clientid,idmsgraphmaster.underlob,idmsgraphmaster.Queryname,idmsgraphmaster.columnname,idmsgraphmaster.columnseries,idmsgraphmaster.todate,idmsgraphmaster.fromdate,idmsgraphmaster.commanformat1,idmsgraphmaster.legendformat,idmsgraphmaster.commanformat2,idmsgraphmaster.commanformat,idmsgraphmaster.specificproperties,idmsgraphmaster.totalcolumn ,idmsgraphmaster.reporttype from idmsgraphmaster where  idmsgraphmaster.graphname='" + ddlgraphname.SelectedItem.Text + "' and idmsgraphmaster.departmentid='60' and idmsgraphmaster.clientid='0' and idmsgraphmaster.underlob='0'"
            End If
...
#End Region
    ...
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        Try
            ...
            clientAna = 0
            lobana = 0
            graphobj.LogDeletegraph(strid, 60, clientAna, lobana, ddlgraphname.SelectedItem.Text, ddlReport.SelectedItem.Text)
            hidDept = 60
            hidClient = 0
            hidlob = 0
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        Try
            ...
            Dim str = objGP.trackUpdateGraph(hidChart.Value, ddlgraphname.SelectedItem.Text, Session("userid"), ddlReport.SelectedItem.Text, 60, clientAna, lobana, "Update")
