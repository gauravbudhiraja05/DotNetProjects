...
<div>
    <asp:textbox id="txtSort" style="Z-INDEX: 100; LEFT: 952px; POSITION: absolute; TOP: 45px" runat="server"
			...
			<table cellspacing="0" cellpadding="0" width="90%" class="table" summary="Purpose of this page is Creating New Department">
				<caption style ="background-color:#0591D3">Add Department</caption>
				
				<tr>
					<td colspan="2" scope="colgroup">&nbsp;</td>
				</tr>
				<tr>
					<td class="label" style="height: 20px; color :Black " scope="col">Department Name
					</td>
					...
					<td valign="top" align="center" colspan="2" style="height: 452px" scope="colgroup">
						...
						<asp:datagrid id="grdlob" runat="server" Width="100%" AutoGenerateColumns="False" AllowSorting="True" 
								...
								<Columns>
									<asp:TemplateColumn>
										<HeaderTemplate>
										<asp:LinkButton id="Linkbutton1" Runat="server"    CommandName="DeptName"   text='Department Name' >
									...
									<asp:TemplateColumn>
										...
										<HeaderTemplate>
											<center>
												<asp:LinkButton id="lkbtnSelectAll" Runat="server" CommandName="Select All" ToolTip="Select All CheckBox"  >Select All /</asp:LinkButton>
												<asp:LinkButton id="lkbtnDeSelectAll" Runat="server" CommandName="DeSelect All" ToolTip="DeSelect All CheckBox"  >DeSelect All</asp:LinkButton>
											</center>
										</HeaderTemplate>
										<ItemTemplate>
											<center>
