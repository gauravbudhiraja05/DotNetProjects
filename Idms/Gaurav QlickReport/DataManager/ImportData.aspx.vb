...
Partial Class DataManager_ImportData
    ...
    Protected Sub ClientName_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ClientName.SelectedIndexChanged
        ...
        If ClientName.SelectedValue = "--Select--" Or ClientName.SelectedValue = "" Then
            ...
            clientid = 0
            lobid = 0
            ddltable_bind(DepartmentName.SelectedValue, 0, 0)
        Else
    ...
    Protected Sub ddlLobName_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlLobName.SelectedIndexChanged
        ...
        If ddlLobName.SelectedItem.Text = "--Select--" Or ddlLobName.SelectedValue = "" Then
            ddltable_bind(deptid, clientid, 0)
        Else
            ddltable_bind(deptid, clientid, lobid)
        End If
    ...
    Protected Sub btnImport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnImport_multiuser.Click
        ...
        Try
            ...
            ElseIf Right(txtFile.PostedFile.FileName, 3) <> "xls" Then
                If Right(txtFile.PostedFile.FileName, 4) <> "xlsx" Then
                    Showmsg("Please Select File of type Microsoft Excel Workbook to Upload")
                    Exit Sub
                End If
    ...
    Protected Sub ddlLob_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlLob.SelectedIndexChanged
        If (ddlLobName.SelectedValue = "" Or ddlLobName.SelectedValue = "--Select--") Then
            ddlTable.Items.Clear()
            ddltable_bind(DepartmentName.SelectedValue, ClientName.SelectedValue, 0)
        Else
            ddltable_bind(DepartmentName.SelectedValue, ClientName.SelectedValue, ddlLobName.SelectedValue)
        End If
    End Sub
End Class
