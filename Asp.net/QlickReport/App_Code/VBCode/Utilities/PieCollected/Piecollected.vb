...
#Region "Fields"
        ...
        ''' </summary> 
        Public CollectedPercentage As Double = 5
...
#Region "Constructor"
        ...
        Public Sub New(ByVal chartControl As Chart)
            ...
            AddHandler Me.chartControl.PostPaint, AddressOf Me.chart_PostPaint
        End Sub
...
#Region "Methods"
        ...
        Public Sub ShowSmallSegmentsAsSupplementalPie(ByVal seriesName As String)
            ...
            End If
            If Me.CollectedPercentage > 100 OrElse Me.CollectedPercentage < 0 Then
            ...
            If Me.series.Type <> SeriesChartType.Pie And series.Type <> SeriesChartType.Doughnut Then
            ...
            If CreateCollectedPie() Then
                ...
                Me.supplementalSeries.Type = Me.series.Type
                ...
                Me.supplementalSeries.ShowLabelAsValue = Me.series.ShowLabelAsValue
        ...
        Private Function CreateCollectedPie() As Boolean
            ...
            Dim minValue As Double = total / 100 * Me.CollectedPercentage
            ...
            For index As Integer = 0 To Me.series.Points.Count - 1
                Dim pointValue As Double = Math.Abs(Me.series.Points(index).YValues(0))
                If pointValue <= minValue And series.Points(index)!colectedDataPoint Then
            ...
            If collectedValue > 0 Then
                ...
                Dim startAngle As Integer = CInt(Math.Round(Me.collectedPieSliceAngle / 2))
        ...
        Private Sub chart_PostPaint(ByVal sender As Object, ByVal e As Dundas.Charting.WebControl.ChartPaintEventArgs)
