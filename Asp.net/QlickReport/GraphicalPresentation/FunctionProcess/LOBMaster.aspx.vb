...
Partial Class Function_And_Process_LOBMaster
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Try
            ...
            If (ClientId = "0" Or ClientId = "") Then
                WARSShowMsg("Please Select Client Name!")
                Exit Sub
            End If
            ...
            'End If
            If txtLob.Text = "" Then
                WARSShowMsg("Please Fill LOB Name!")
                Exit Sub
            End If
            ...
            If com.ExecuteNonQuery() <> -1 Then
                WARSShowMsg("LOB Added Successfully.")
                txtLob.Text = ""
                txtDescript.Text = ""
            End If
            com.Dispose()
    ...
    Private Function CheckExist(ByVal lob As String)
        ...
        If rdr.Read Then
            WARSShowMsg("This LOB Name Already Exists")
            rdr.Close()
            connection.Close()
            com.Dispose()
            Return False
    ...
    Private Sub grdlob_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles grdlob.ItemCommand
        ...
        If e.CommandName = "EditSave" Then
            ...
            If lob = "" Then
                ...
                WARSShowMsg(" LOB Name can not be Blank")
    ...
    Private Sub UpdateLobName(ByVal name, ByVal msg, ByVal autoid)
        ...
        connection.Open()
        If com.ExecuteNonQuery() <> -1 Then
            WARSShowMsg("LOB Updated Successfully.")
        End If
        connection.Close()
        com.Dispose()
    End Sub
    ...
    Private Sub dlbind(ByVal control As WebControls.DataGrid)
        Dim objcmd
        objcmd = New SqlCommand("select dpt.departmentname,cl.clientname,lob.AutoId,lob.LOBName,lob.Description,SaveDate=convert(varchar,lob.SaveDate,106),lob.SavedBy from warslobmaster lob,idmsclient cl,idmsdepartment dpt where lob.clientid*=cl.autoid and lob.DeptId*=dpt.autoid order by dpt.departmentname", connection)
