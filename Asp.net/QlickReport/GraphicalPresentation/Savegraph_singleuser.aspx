<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Savegraph_singleuser.aspx.vb" Inherits="GraphicalPresentation_Savegraph_singleuser" %>
...
<head id="Head1" runat="server">
    ...
    <script language="Javascript">
        ...
        function onLoad() {
            ...
            document.getElementById("hiddepartment").value = 60;
            document.getElementById("hidclient").value = 0;
            document.getElementById("hidlob").value = 0;
