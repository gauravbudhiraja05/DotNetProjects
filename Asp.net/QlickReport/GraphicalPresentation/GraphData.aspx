                ...
                <td style="width: 725px" >
                    <div id="Selectreport" runat="server" visible="false">
                        ...
                        <tr>
                           ...
                           <tr id="dept_row" runat="server" visible="false">
                           <td align="center" ><asp:Label ID="select_level1" runat="server" Text="Select level 1" CssClass="label"></asp:Label></td>
                           <td ><asp:DropDownList ID="DepartmentName" Visible="true" CssClass="dropdownlist" 
                                   runat="server" AutoPostBack="True"></asp:DropDownList></td>
                           </tr>
                           <tr id="client_row" runat="server" visible="false">
                           <td align="center"><asp:Label ID="select_level2" runat="server" Text="Select level 2" CssClass="label"></asp:Label></td>
                           <td ><asp:DropDownList ID="ClientName" Visible="true" CssClass="dropdownlist" 
                                   runat="server" AutoPostBack="True"></asp:DropDownList></td>
                           </tr>
                           <tr id="lob_row" runat="server" visible="false">
                           <td align="center"><asp:Label ID="select_level3" runat="server" Text="Select level 3" CssClass="label"></asp:Label></td>
                           <td ><asp:DropDownList ID="ddlLobName" Visible="true" CssClass="dropdownlist" 
                                   runat="server" AutoPostBack="True"></asp:DropDownList></td>
                           </tr>
                           <tr runat="server" id="button_single_row" visible="false">
                           <td colspan="2" align="center">
                               <asp:Button ID="get_report" runat="server" Text=" Get Report" CssClass="button"/></td>
                           </tr>
                        <tr>
                            <td align="center" scope="col"  title="Report Name" nowrap="nowrap" class="style2">
...
<asp:DropDownList ID="ddlgraphname" runat="server" CssClass="dropdownlist"  AutoPostBack="true"></asp:DropDownList>
                        ...
                        <div id ="analysistable" >
                         ...
                         <div id="date">
                        <table summary="" runat="server" visible="false">
                         <tr>
                    ...
                    <table width="100%" summary="">
                      <tr>
                        ...
                        <td title="Click On Show Report Button To Show The Report Column ">
                        <asp:Button ID="ShowReport" Visible="false" runat="server" Text="Get Columns" CssClass="button" />
                        <asp:Button ID="ShowReport_singleuser" runat="server" Text="Get Columns" 
 ...
 <label for="ctl00_MainPlaceHolder_repcols" ></label>   
                            ...
                            <td align="center">
<label for="ctl00_MainPlaceHolder_selectedcols" >
                                <asp:Button ID="add" runat="server" Text=">>" CssClass="button" Width="40px" ToolTip="Click on button to add items" />    
                                <br />
                                <asp:Button ID="remove" runat="server" Text="<<" CssClass="button" Width="40px"  ToolTip="Click on button to remove items" />
                                </label>   
        ...
        <tr>
            ...
            <td align="left" colspan="8" scope="colgroup" title=" Click on Graph Button" 
                class="style4">
            <asp:Button ID="btnGraph" Visible="false" runat="server" Text="Plot Graph" CssClass="button" ToolTip="Click To Show Graph" Width="96px"   />&nbsp;<asp:Button 
                    ID="btnGraph_singleuser" runat="server" Text="Plot Graph" CssClass="button" 
                    ToolTip="Click To Show Graph" Width="96px"   />&nbsp;
            <input type="button" Visible="false" id="btnsave" runat="server" onclick="javascript:return Savegraphs();" class="button" name="SaveGraph" title="Click To Save Graph" value="Save" style="width: 73px" />  
                <input type="button" runat="server" id="btnsave_singleuser" 
                    onclick="javascript:return Savegraphs_singleuser();" class="button" 
                    name="SaveGraph0" title="Click To Save Graph" value="Save" 
                    style="width: 73px" />  
                <%--<img src="../images/Chart/RunChart.jpg"/>--%>
            <asp:Button ID="btnOpenGraph"  runat="server" Text="OpenGraph" Visible="false"  CssClass="button" ToolTip="Click To Open Graph" Width="88px"   />
                &nbsp;&nbsp;
            <asp:Button ID="btnOpenGraph_singleuser"  runat="server" Text="OpenGraph"  
                    CssClass="button" Visible="false" ToolTip="Click To Open Graph" Width="88px"   />
            </td>
        </tr>
                <tr>
                    <td align="center" colspan="1" scope="col" style="width: 107px; height: 13px" title=" Click on Graph Button">
