...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="style1">
     <caption>
        ...
        <td></td>
        <td><asp:Label ID="deptname" CssClass="label" runat="server" Text="Label"></asp:Label></td>
        <td><asp:DropDownList ID="chdept" CssClass="dropdownlist" runat="server" 
                AutoPostBack="True" ></asp:DropDownList></td>
        </tr>
         <tr runat="server" id="client_row" visible="false">
        <td></td>
        <td><asp:Label ID="clientname" CssClass="label" runat="server" Text="Label"></asp:Label></td>
        <td><asp:DropDownList ID="chclient" CssClass="dropdownlist" runat="server" 
                AutoPostBack="True"></asp:DropDownList></td>
        </tr>
         <tr runat="server" id="lob_row" visible="false">
        <td></td>
        <td><asp:Label ID="ddllobname" CssClass="label" runat="server" Text="Label"></asp:Label></td>
        <td><asp:DropDownList ID="chlob" runat="server" CssClass="dropdownlist"></asp:DropDownList></td>
        </tr>
        <tr><td></td>
                <td align="right">
                <asp:Button ID="data_import" runat="server" CssClass="button" Text="Import Data" Visible="false"/>
                </td>
                <td align="left"><asp:Button ID="data_import_singleuser" runat="server" CssClass="button" Text="Import Data" Visible="false"/>
                </td>
                </tr>
    </table>
