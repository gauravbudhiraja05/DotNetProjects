<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="createandimport.aspx.vb" Inherits="TableTools_createandimport" %>
					...
					<td>
						<table id="tabtop" rules="rows" class="table" align="center" runat="server">
							<tbody>
								...
								<tr>
									<td class="style3"><asp:label id="lblFileName" Runat="server" AssociatedControlID ="myfile" text="File Name" CssClass ="label" ToolTip='"File name for creating a table"'></asp:label>:-</td>
    ...
    class="button" /></td>
        ...
        <tr>
            ...
            <td colspan="3" style="height: 20px">
				...
				<tr>
					<td class="style4"><asp:label id="lbltablename" Runat="server" CssClass="label" text="Table Name"></asp:label>:-</td>
