...
//					}
        ...
        function chkvalidsave2()
			...
			{
				document.getElementById("<%=txtval11.ClientId %>").value = window.showModalDialog('/QlickReport/Calendar/Calendar.htm',document.getElementById("<%=txtval11.ClientId %>").value, 'dialogLeft:200px;dialogTop:200px;dialogHeight:210px;dialogWidth:265px;center:No;help:No;scroll:No;resizable:No;status:No;');
			}
			function ShowCalendar2()
			{
				document.getElementById("<%=txtval12.ClientId %>").value = window.showModalDialog('/QlickReport/Calendar/Calendar.htm',document.getElementById("<%=txtval12.ClientId %>").value, 'dialogLeft:200px;dialogTop:200px;dialogHeight:210px;dialogWidth:265px;center:No;help:No;scroll:No;resizable:No;status:No;');
			}
			function ShowCalendar3()
			{
				document.getElementById("<%=txtval13.ClientId %>").value = window.showModalDialog('/QlickReport/Calendar/Calendar.htm',document.getElementById("<%=txtval13.ClientId %>").value, 'dialogLeft:200px;dialogTop:200px;dialogHeight:210px;dialogWidth:265px;center:No;help:No;scroll:No;resizable:No;status:No;');
			}
			function ShowCalendar4()
			{
				document.getElementById("<%=txtval14.ClientId %>").value = window.showModalDialog('/QlickReport/Calendar/Calendar.htm',document.getElementById("<%=txtval14.ClientId %>").value, 'dialogLeft:200px;dialogTop:200px;dialogHeight:210px;dialogWidth:265px;center:No;help:No;scroll:No;resizable:No;status:No;');
			}
			function ShowCalendar5()
			{
				document.getElementById("<%=txtval15.ClientId %>").value = window.showModalDialog('/QlickReport/Calendar/Calendar.htm',document.getElementById("<%=txtval15.ClientId %>").value, 'dialogLeft:200px;dialogTop:200px;dialogHeight:210px;dialogWidth:265px;center:No;help:No;scroll:No;resizable:No;status:No;');
			}
			function ShowCalendar6()
			{
				document.getElementById("<%=txtval21.Clientid %>").value = window.showModalDialog('/QlickReport/Calendar/Calendar.htm',document.getElementById("<%=txtval21.Clientid %>").value, 'dialogLeft:200px;dialogTop:200px;dialogHeight:210px;dialogWidth:265px;center:No;help:No;scroll:No;resizable:No;status:No;');
			}
			function ShowCalendar7()
			{
				document.getElementById("<%=txtval22.Clientid %>").value = window.showModalDialog('/QlickReport/Calendar/Calendar.htm',document.getElementById("<%=txtval22.Clientid %>").value, 'dialogLeft:200px;dialogTop:200px;dialogHeight:210px;dialogWidth:265px;center:No;help:No;scroll:No;resizable:No;status:No;');
			}
			function ShowCalendar8()
			{
				document.getElementById("<%=txtval23.Clientid %>").value = window.showModalDialog('/QlickReport/Calendar/Calendar.htm',document.getElementById("<%=txtval23.Clientid %>").value, 'dialogLeft:200px;dialogTop:200px;dialogHeight:210px;dialogWidth:265px;center:No;help:No;scroll:No;resizable:No;status:No;');
			}
			function ShowCalendar9()
			{
				document.getElementById("<%=txtval24.Clientid %>").value = window.showModalDialog('/QlickReport/Calendar/Calendar.htm',document.getElementById("<%=txtval24.Clientid %>").value, 'dialogLeft:200px;dialogTop:200px;dialogHeight:210px;dialogWidth:265px;center:No;help:No;scroll:No;resizable:No;status:No;');
			}
			function ShowCalendar10()
			{
				document.getElementById("<%=txtval25.Clientid %>").value = window.showModalDialog('/QlickReport/Calendar/Calendar.htm',document.getElementById("<%=txtval25.Clientid %>").value, 'dialogLeft:200px;dialogTop:200px;dialogHeight:210px;dialogWidth:265px;center:No;help:No;scroll:No;resizable:No;status:No;');
			}
...
<input id="txtval11" style="WIDTH: 112px; HEIGHT: 18px" tabindex="45" type="text" size="13"
											...
											<%--<input id="imageFromDate" title="Select Date" style="BORDER-RIGHT: 0px solid; background-image : url(../Calendar/Calendar_Date.gif); BORDER-LEFT: 0px solid; WIDTH: 27px;  CURSOR: hand; " 
...
<input id="txtval12" style="WIDTH: 112px; HEIGHT: 18px" tabindex="49" type="text" size="13"
											name="txtval12" runat="server"/>
                                            <%--<input id="imageFromDate1" title="Select Date" style="BORDER-RIGHT: 0px solid; BACKGROUND: url(../Calendar/Calendar.gif); BORDER-LEFT: 0px solid; WIDTH: 27px; CURSOR: hand; BORDER-BOTTOM: 0px solid;  "
...
<input id="txtval14" style="WIDTH: 112px; HEIGHT: 18px" tabindex="57" type="text" size="13"
											name="txtval14" runat="server"/>
                                            <%--<input id="imageFromDate3" title="Select Date" style="BORDER-RIGHT: 0px solid; BACKGROUND: url(../Calendar/Calendar.gif); BORDER-LEFT: 0px solid; WIDTH: 27px; CURSOR: hand; BORDER-BOTTOM: 0px solid; "
...
<input id="txtval15" style="WIDTH: 112px; HEIGHT: 18px" tabindex="61" type="text" size="13"
											name="txtval15" runat="server"/>
                                           <%-- <input id="imageFromDate4" title="Select Date" style="BORDER-RIGHT: 0px solid; BACKGROUND: url(../Calendar/Calendar.gif); BORDER-LEFT: 0px solid; WIDTH: 27px; CURSOR: hand; BORDER-BOTTOM: 0px solid;" 
...
<input id="txtval21" style="WIDTH: 112px; HEIGHT: 18px" tabindex="65" type="text" size="13"
											name="txtval21" runat="server"/>
                                            <%--<input id="imageFromDate5" title="Select Date" style="BORDER-RIGHT: 0px solid; BACKGROUND: url(../Calendar/Calendar.gif); BORDER-LEFT: 0px solid; WIDTH: 27px; CURSOR: hand; BORDER-BOTTOM: 0px solid;" 
...
<input id="txtval22" style="WIDTH: 112px; HEIGHT: 18px" tabindex="69" type="text" size="13"
											name="txtval22" runat="server"/>
                                            <%--<input id="imageFromDate6" title="Select Date" style="BORDER-RIGHT: 0px solid; BACKGROUND: url(../Calendar/Calendar.gif); BORDER-LEFT: 0px solid; WIDTH: 27px; CURSOR: hand; BORDER-BOTTOM: 0px solid;" 
...
<input id="txtval23" style="WIDTH: 112px; HEIGHT: 18px" tabindex="73" type="text" size="13"
											name="txtval23" runat="server"/>
                                           <%-- <input id="imageFromDate7" title="Select Date" style="BORDER-RIGHT: 0px solid; BACKGROUND: url(../Calendar/Calendar.gif); BORDER-LEFT: 0px solid; WIDTH: 27px; CURSOR: hand; BORDER-BOTTOM: 0px solid;"
...
<input id="txtval24" style="WIDTH: 112px; HEIGHT: 18px" tabindex="77" type="text" size="13"
											name="txtval24" runat="server"/>
                                           <%-- <input id="imageFromDate8" title="Select Date" style="BORDER-RIGHT: 0px solid; BACKGROUND: url(../Calendar/Calendar.gif); BORDER-LEFT: 0px solid; WIDTH: 27px; CURSOR: hand; BORDER-BOTTOM: 0px solid; "
...
<input id="txtval25" style="WIDTH: 112px; HEIGHT: 18px" tabindex="81" type="text" size="13"
											name="txtval25" runat="server"/>
                                           <%-- <input id="imageFromDate9" title="Select Date" style="BORDER-RIGHT: 0px solid; BACKGROUND: url(../Calendar/Calendar.gif); BORDER-LEFT: 0px solid; WIDTH: 27px; CURSOR: hand; BORDER-BOTTOM: 0px solid;"
