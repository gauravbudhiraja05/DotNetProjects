...
function cmdsaveas_onclick() {
		...
		<body>
			<table width="90%" align="center" class="table">
                ...
                <tr>
                <td>
                <table runat="server" visible="true" id="savespandisplay" class="table" >
                <tr id="dept_id" runat="server">
				...
				<tr>
					...
					<label for="ctl00_MainPlaceHolder_txtname" ></label>
						<asp:TextBox ID="txtname" Runat="server" MaxLength="50" Width="160px"></asp:TextBox>&nbsp;
							...
							<asp:Button ID="cmdsaveas" Text="Save As" OnClientClick="javascript:chkname();" CssClass="button" runat="server" visible="false" style="WIDTH: 144px; HEIGHT: 20px" />
                            <%--<input class="button" runat="server" id="cmdcreatetab" style="WIDTH: 144px; HEIGHT: 20px" onclick="javascript:chkvalidation();"
							tabindex="74" visible="false"   type="button" value="Save View"/>--%>
                            <asp:Button ID="cmdcreatetab" runat="server" Text="Save View" style="WIDTH: 144px; HEIGHT: 20px" CssClass="button" onClientClick="javascript:chkvalidation();" Visible="false" />
