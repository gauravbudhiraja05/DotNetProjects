...
<label   for="htmlqueryname"></label>
			...
			<table style="BACKGROUND-COLOR: white" cellspacing="0" cellpadding="0" border="0" summary="">
				<tr>
					...
					<td scope="col" style="WIDTH: 35px"><asp:imagebutton id="imgexl" alt="IMGEXL" BorderWidth="0" height="25" width="25" Runat="server" ImageUrl="/AutoWhiz/Images/excel_32.gif"></asp:imagebutton></td>
					<%--<td scope="col" style="WIDTH: 35px"><img style="MARGIN-TOP: 0px; MARGIN-LEFT: 0px; MARGIN-RIGHT: 0px" alt="View Chart" src="/AutoWhiz/Images/data_32.gif" width="25" id="IMG1" language="javascript" onclick="return IMG1_onclick()" /></td>--%>
				</tr>
			</table>
			<table summary="">
			    <tr>
							...
							<table>								
								...
								<tr>
								    <td>
								        <table>
								            <tr>
									            <td id="dept_td" runat="server" visible="false" scope="col"><label  class="label" for="ddlDept">Department</label></td>
								    ...
								    <td>
								        <table>
								            <tr>
								                ...
								                <td scope="col"><asp:button id="cmdsave" Visible="false" Runat="server" CssClass="button" Text="Save as HTML"></asp:button></td>
								                <td scope="col"><asp:button id="cmdsave_singleuser" Visible="false" Runat="server" CssClass="button" Text="Save as HTML"></asp:button></td>
