<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Drildown.aspx.vb" Inherits="QueryBuilder_Drildown" %>
...
<body>
    ...
    <table summary="">
        <tr>    
            <td>
                <label id="ErrMsg" runat="server" style="color:Red"></label>
            </td>
        </tr>
    </table>
    ...
    <input type="hidden" name="__EVENTTARGET"/> <input type="hidden" name="__EVENTARGUMENT"/>
			...
			<table summary="" style="BACKGROUND-COLOR: white" cellspacing="0" cellpadding="0" border="0">
				<tr>
							...
							<table>								
								...
								<tr>
								    <td>
								        <table>
								            <tr>
									            <td scope="col"><label for="ddlDept" class="label">Department</label></td>
