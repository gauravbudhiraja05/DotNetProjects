...
Partial Class QueryBuilder_Welcome
    ...
    Public Sub ddlTablename_bind()
        Dim query As String = "select tablename from warslobtablemaster where DepartmentId='60' and ClientId='0' and LOBId='0' and createdby='" + Session("userid") + "'"
        ...
        'ddlTableName.Items.Insert(1, "Get Tables")
        'SetsFocus(ddlTableName)
        objCbo1Cmd.Dispose()
    End Sub
    'Public Sub ddlTablename1_bind()
    '    Dim query As String = "select tablename from warslobtablemaster where DepartmentId='" + ddlDept.SelectedValue + "' and ClientId='" + ddlClient.SelectedValue + "' and LOBId='" + ddlLob.SelectedValue + "' and createdby='" + Session("userid") + "'"
    '    Dim objCbo1Cmd As New SqlCommand
    '    Dim adp As New SqlDataAdapter
    '    Dim ds As New DataSet
    '    objCbo1Cmd.Connection = connection
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If rdr.Read Then
            ...
            If (producttype = "Multiple User") Then
                ...
                'ddlTablename1_bind()
            Else
                'Button3_singleuser.Visible = True
                'Button1_singleuser.Visible = True
                ' get_tables.Visible = True
                ddlTableName.Visible = True
                Me.ddlTableName.Attributes.Add("onchange", "tabstatus1();")
                'Me.ddlTableName.Attributes.Add("onchange", "filltable1();")
                ddlTablename_bind()
                'getdata()
                'Me.get_tables.Attributes.Add("onClick", "getdata1();")
            End If
        End If
