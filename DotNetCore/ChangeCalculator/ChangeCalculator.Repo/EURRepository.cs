...
{
    public class EURRepository : Repository, IEURRepository
    {
        public Calculator GetEURDenominations(Calculator calculator)
        {
            ...
            if (calculator.CurrencyType == "EUR")
            {
                int[] rupeeDenominations = new int[] { 500, 200, 100, 50, 20, 10, 5 };
                ...
                for (int j = 0; j < 6; j++)
                {
                    ...
                    if (paisa > 0)
                    {
                        ...
                        denominationsList.Add(paisa + " x £" + paiseDenominations[j] + " c");
                    }
                }
