...
function checkRewarAmtValidOrNot() {
    ...
    // If amount is enter through dropdown
    // not need to code here because  it is always select an amount
...
var onSuccessEdit = function (context) {
    ...
    if ($("#hdnIsRewardSend").val() == "false") {
        ...
        swal({
            title: 'The reward has been updated successfully.',
            text: '',
            type: 'success',
            width: '500px'
        }).then(function () {
