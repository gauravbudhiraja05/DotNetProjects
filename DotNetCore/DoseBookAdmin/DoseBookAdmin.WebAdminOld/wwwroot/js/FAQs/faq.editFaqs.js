...
$(document).ready(function () {
    ...
    bkLib.onDomLoaded(function () {
        ...
        if ($('#hdnLoggedInUserRoleType').val() == "DA") {
            if ($('#IsReadableOnly').val().toLowerCase() == "true") {
                if ($('#hdnLoggedInUserId').val() != $('#hdnCreatedBy').val()) {
                    document.getElementsByClassName(' nicEdit-panel')[0].classList.add("isDisabled");
                    document.getElementsByClassName(' nicEdit-main ')[0].classList.add("isDisabled");
...
$(window).on('load', function () {
    ...
    setTimeout(function () {
        ...
        onEditPageLoadOpenSelectedDocs();
...
function onEditPageLoadOpenSelectedDocs() {
    ...
    for (i = 0; i < selectobject.length; i++) {
        ...
        $(selectobject[i]).parents(".section").parents(".section").removeClass('collapsed');
        $(selectobject[i]).parents(".section").removeClass('collapsed');
