$(document).ready(function () {
    ...
    $("#Save_MedicineDose_Btn").click(function (event) {
        ...
        // Get form
        var form = $('#AddformMedicineDose')[0];
        ...
        $.ajax({
            ...
            url: "/MedicineDose/AddMedicineDose",
...
var validateAddMedicineDoseMessage = function () {
    ...
    if (!$("#AddformMedicineDose").valid()) {
        $("#AddformMedicineDose").submit();
        isValid = false;
    }
