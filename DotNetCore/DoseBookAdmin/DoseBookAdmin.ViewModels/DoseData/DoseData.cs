...
namespace DoseBookAdmin.ViewModels.DoseData
{
    public class DoseMetaTypeListGridItemVM
    {
        public List<DoseMetaType> AllDoseMetaTypes { get; set; }
        public List<DoseData> AllDoseDatas { get; set; }
        public DoseMetaType SelectedDoseMetaType { get; set; }
    }

    public class DoseMetaType
    {
